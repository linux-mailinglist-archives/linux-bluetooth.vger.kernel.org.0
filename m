...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 04A12432A04
	for <lists+linux-bluetooth@lfdr.de>; Tue, 19 Oct 2021 01:09:02 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S233108AbhJRXLM (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Mon, 18 Oct 2021 19:11:12 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54566 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S233024AbhJRXLL (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Mon, 18 Oct 2021 19:11:11 -0400
Received: from mail-pl1-x633.google.com (mail-pl1-x633.google.com [IPv6:2607:f8b0:4864:20::633])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DA5A0C06161C
        for <linux-bluetooth@vger.kernel.org>; Mon, 18 Oct 2021 16:08:59 -0700 (PDT)
Received: by mail-pl1-x633.google.com with SMTP id y1so12331945plk.10
        for <linux-bluetooth@vger.kernel.org>; Mon, 18 Oct 2021 16:08:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=L/S7wPX417/a99/BF8q/oLz3tqk9p1+fU48Tc5SHr0U=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=L/S7wPX417/a99/BF8q/oLz3tqk9p1+fU48Tc5SHr0U=;
        b=
X-Gm-Message-State: AOAM532IJy9mxIBI6W3WHIbKUmB0lGwNR9hPlajjj/lQRewR/XQRfZ0E
        Pgg7GY9QKGEDvn0IvsmR19NSotOQ7srxCQ==
X-Google-Smtp-Source: ABdhPJwSPq+8Sjy2GwDc/1DxNBOSa54oBJVp5XWbrWslbFyvJ8MhyvRbZ+YNoNkRw9HmKL6Q1r9k9g==
X-Received: by 2002:a17:90b:4a81:: with SMTP id lp1mr2169576pjb.124.1634598538157;
        Mon, 18 Oct 2021 16:08:58 -0700 (PDT)
Received: from han1-NUC8i7BEH.hsd1.or.comcast.net ([2601:1c0:6a01:d830:1898:ddd4:7bc6:9e0d])
        by smtp.gmail.com with ESMTPSA id s30sm13469456pgn.38.2021.10.18.16.08.57
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 18 Oct 2021 16:08:57 -0700 (PDT)
From:   Tedd Ho-Jeong An <hj.tedd.an@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [RFC BlueZ PATCH v12 4/4] tools/mgmt-tester: Add LL Privacy test cases
Date:   Mon, 18 Oct 2021 16:08:53 -0700
Message-Id: <20211018230853.134320-4-hj.tedd.an@gmail.com>
...
index 64a5e1c3d..40c7dcfb5 100644
...
@@ -289,6 +303,7 @@ struct generic_data {
...
+	const struct hci_cmd_data *expect_hci_list;
 	...
 	uint8_t pin_len;
 	const void *pin;
@@ -1737,6 +1752,7 @@ static uint16_t settings_powered_le[] = { MGMT_OP_SET_LE,
...
@@ -2100,24 +2116,6 @@ static const struct generic_data start_discovery_valid_param_power_off_1 = {
...
@@ -4479,71 +4477,6 @@ static const struct generic_data add_device_success_5 = {
...
-
 static const uint8_t remove_device_nval_1[] = {
 					0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc,
 					0xff,
@@ -4663,36 +4596,6 @@ static const struct generic_data remove_device_success_6 = {
 	.expect_status = MGMT_STATUS_SUCCESS,
 };
...
@@ -7477,6 +7380,54 @@ static void command_hci_callback(uint16_t opcode, const void *param,
...
+
 ...
 {
@@ -8552,6 +8503,189 @@ static const struct generic_data multi_ext_advertising_add_second = {
...
@@ -9466,6 +9600,7 @@ static const struct generic_data start_discovery_le_1m_coded_scan_param = {
...
+
 static void set_phy_callback(uint8_t status, uint16_t length,
 					const void *param, void *user_data)
 {
@@ -9797,202 +9932,1022 @@ static const struct generic_data set_exp_feat_unknown = {
...
+						NULL, NULL, NULL);
 	...
 	mgmt_send(data->mgmt, MGMT_OP_SET_POWERED, data->mgmt_index,
 					sizeof(param), param,
@@ -10017,6 +10972,28 @@ static bool power_off(uint16_t index)
 	return true;
 }
...
+
 ...
 {
 	struct test_data *data = tester_get_data();
@@ -10055,6 +11032,14 @@ static void test_command_generic(const void *test_data)
 		hciemu_add_central_post_command_hook(data->hciemu,
...
@@ -10201,6 +11186,74 @@ static void test_pairing_acceptor(const void *test_data)
...
+
 static void connected_event(uint16_t index, uint16_t length, const void *param,
 							void *user_data)
 {
@@ -11228,13 +12281,6 @@ int main(int argc, char *argv[])
...
@@ -11653,26 +12699,6 @@ int main(int argc, char *argv[])
...
@@ -11704,20 +12730,6 @@ int main(int argc, char *argv[])
...
@@ -12279,6 +13291,55 @@ int main(int argc, char *argv[])
...
+					test_command_generic);
 	...
 	test_bredrle50("Get PHY Success", &get_phy_success,
 					NULL, test_command_generic);
@@ -12656,6 +13717,215 @@ int main(int argc, char *argv[])
