...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id D9AC872EB85
	for <lists+linux-bluetooth@lfdr.de>; Tue, 13 Jun 2023 21:05:25 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S240543AbjFMTE3 (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Tue, 13 Jun 2023 15:04:29 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:49862 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S240610AbjFMTEZ (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Tue, 13 Jun 2023 15:04:25 -0400
Received: from mail-lj1-x22c.google.com (mail-lj1-x22c.google.com [IPv6:2a00:1450:4864:20::22c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 023D11BEB
        for <linux-bluetooth@vger.kernel.org>; Tue, 13 Jun 2023 12:04:18 -0700 (PDT)
Received: by mail-lj1-x22c.google.com with SMTP id 38308e7fff4ca-2b1a46ad09fso74154461fa.2
        for <linux-bluetooth@vger.kernel.org>; Tue, 13 Jun 2023 12:04:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1686683056; x=1689275056;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=aDtt+rI9a23DNxcjq/ouCFiwQ6Apo8dp4f3+drCZNp8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1686683056; x=1689275056;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=aDtt+rI9a23DNxcjq/ouCFiwQ6Apo8dp4f3+drCZNp8=;
        b=
X-Gm-Message-State: AC+VfDwf3ChmZ1zblKmhwJJvcWz4cU3pIs32JQ1LMCWDasiF1/xPN9mt
        ioSYBlLGUhat0vbR/jYO4ywx1WTArQ3/nX5WZvGDmJxd6eCVyUp+
X-Google-Smtp-Source: ACHHUZ4XTf2gF5Q2rzXHltgj/vCFvARA01AyMDSLFQ+P3REz3OjmB3FN4kJSmYTbGmNbKFoCoFpHe45i4tHSgmwfbdQ=
X-Received: by 2002:a2e:9819:0:b0:2b3:31c1:c747 with SMTP id
 a25-20020a2e9819000000b002b331c1c747mr2551469ljj.24.1686683055675; Tue, 13
 Jun 2023 12:04:15 -0700 (PDT)
MIME-Version: 1.0
...
Date:   Tue, 13 Jun 2023 12:04:02 -0700
Message-ID: <CABBYNZ+B-5xz8BLB31KOEUhA7jWWfsMQmDF+YgPXrP1O0Ox1Ng@mail.gmail.com>
...
On Tue, Jun 13, 2023 at 11:17=E2=80=AFAM Pauli Virtanen <pav@iki.fi> wrote:
>
...
>         u8  privacy_mode;
>  };
> @@ -1605,6 +1607,9 @@ struct hci_conn_params *hci_conn_params_add(struct =
hci_dev *hdev,
>                                             bdaddr_t *addr, u8 addr_type)=
;
>  void hci_conn_params_del(struct hci_dev *hdev, bdaddr_t *addr, u8 addr_t=
ype);
...
> @@ -118,7 +118,7 @@ static void hci_connect_le_scan_cleanup(struct hci_co=
nn *conn, u8 status)
>          */
...
> @@ -127,10 +127,10 @@ static void hci_connect_le_scan_cleanup(struct hci_=
conn *conn, u8 status)
>                 return;
...
> +               hci_conn_params_set_pending(params, &hdev->pend_le_report=
s);
>                 break;
>         default:
>                 break;
> @@ -1435,8 +1435,7 @@ static int hci_explicit_conn_params_set(struct hci_=
dev *hdev,
...
> @@ -2249,21 +2249,41 @@ struct hci_conn_params *hci_conn_params_lookup(st=
ruct hci_dev *hdev,
>         return NULL;
>  }
>
...
>                                             bdaddr_t *addr, u8 addr_type)
> @@ -2297,14 +2317,15 @@ struct hci_conn_params *hci_conn_params_add(struc=
t hci_dev *hdev,
>         return params;
>  }
>
...
>         kfree(params);
>  }
> @@ -2342,8 +2363,7 @@ void hci_conn_params_clear_disabled(struct hci_dev =
*hdev)
>                         continue;
>                 }
>
...
> @@ -1564,7 +1564,7 @@ static u8 hci_cc_le_set_privacy_mode(struct hci_dev=
 *hdev, void *data,
>
>         params =3D hci_conn_params_lookup(hdev, &cp->bdaddr, cp->bdaddr_t=
ype);
>         if (params)
...
>         hci_dev_unlock(hdev);
>
> @@ -2804,8 +2804,8 @@ static void hci_cs_disconnect(struct hci_dev *hdev,=
 u8 status)
>
>                 case HCI_AUTO_CONN_DIRECT:
>                 case HCI_AUTO_CONN_ALWAYS:
...
>
>                 default:
> @@ -3423,8 +3423,8 @@ static void hci_disconn_complete_evt(struct hci_dev=
 *hdev, void *data,
>
>                 case HCI_AUTO_CONN_DIRECT:
>                 case HCI_AUTO_CONN_ALWAYS:
...
>                         break;
>
> @@ -5972,7 +5972,7 @@ static void le_conn_complete_evt(struct hci_dev *hd=
ev, u8 status,
>         params =3D hci_pend_le_action_lookup(&hdev->pend_le_conns, &conn-=
>dst,
>                                            conn->dst_type);
>         if (params) {
> -               list_del_init(&params->action);
...
>                 return 0;
> @@ -2203,6 +2211,16 @@ static int hci_le_add_resolve_list_sync(struct hci=
_dev *hdev,
...
> @@ -2215,7 +2233,7 @@ static int hci_le_add_resolve_list_sync(struct hci_=
dev *hdev,
>
...
>         struct smp_irk *irk;
> @@ -2240,6 +2258,8 @@ static int hci_le_set_privacy_mode_sync(struct hci_=
dev *hdev,
...
>  }
> @@ -2249,7 +2269,7 @@ static int hci_le_set_privacy_mode_sync(struct hci_=
dev *hdev,
...
> @@ -2447,6 +2467,51 @@ struct sk_buff *hci_read_local_oob_data_sync(struc=
t hci_dev *hdev,
...
> @@ -2466,7 +2531,7 @@ struct sk_buff *hci_read_local_oob_data_sync(struct=
 hci_dev *hdev,
>   */
...
> @@ -2504,6 +2569,7 @@ static u8 hci_update_accept_list_sync(struct hci_de=
v *hdev)
>                 if (hci_conn_hash_lookup_le(hdev, &b->bdaddr, b->bdaddr_t=
ype))
>                         continue;
>
...
>                                                       &b->bdaddr,
>                                                       b->bdaddr_type);
> @@ -2532,9 +2598,15 @@ static u8 hci_update_accept_list_sync(struct hci_d=
ev *hdev)
...
>                         goto done;
>         }
> @@ -2543,8 +2615,11 @@ static u8 hci_update_accept_list_sync(struct hci_d=
ev *hdev)
...
>                         goto done;
>         }
> @@ -4837,12 +4912,12 @@ static void hci_pend_le_actions_clear(struct hci_=
dev *hdev)
>         struct hci_conn_params *p;
>
...
> @@ -1303,15 +1303,15 @@ static void restart_le_actions(struct hci_dev *hd=
ev)
...
> +                       hci_conn_params_set_pending(p, &hdev->pend_le_con=
ns);
>                         break;
>                 case HCI_AUTO_CONN_REPORT:
> -                       list_add(&p->action, &hdev->pend_le_reports);
> +                       hci_conn_params_set_pending(p, &hdev->pend_le_rep=
orts);
>                         break;
>                 default:
>                         break;
> @@ -5175,7 +5175,7 @@ static int set_device_flags(struct sock *sk, struct=
...
> @@ -7586,7 +7586,7 @@ static int hci_conn_params_set(struct hci_dev *hdev=
, bdaddr_t *addr,
...
> @@ -7595,18 +7595,22 @@ static int hci_conn_params_set(struct hci_dev *hd=
ev, bdaddr_t *addr,
...
>         }
>
> @@ -7829,9 +7833,7 @@ static int remove_device(struct sock *sk, struct hc=
i_dev *hdev,
>                         goto unlock;
>                 }
>
...
;
>         } else {
> @@ -7862,9 +7864,7 @@ static int remove_device(struct sock *sk, struct hc=
i_dev *hdev,
>                                 p->auto_connect =3D HCI_AUTO_CONN_EXPLICI=
T;
>                                 continue;
>                         }
> -                       list_del(&p->action);
...
>                 }
>
>                 bt_dev_dbg(hdev, "All LE connection parameters were remov=
ed");
> --
> 2.40.1
>
