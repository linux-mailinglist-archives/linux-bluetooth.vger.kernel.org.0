...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 408177544E6
	for <lists+linux-bluetooth@lfdr.de>; Sat, 15 Jul 2023 00:17:16 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229914AbjGNWRO (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Fri, 14 Jul 2023 18:17:14 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57416 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230044AbjGNWRN (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Fri, 14 Jul 2023 18:17:13 -0400
Received: from mail-pf1-x42b.google.com (mail-pf1-x42b.google.com [IPv6:2607:f8b0:4864:20::42b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 6B6D42D66
        for <linux-bluetooth@vger.kernel.org>; Fri, 14 Jul 2023 15:16:59 -0700 (PDT)
Received: by mail-pf1-x42b.google.com with SMTP id d2e1a72fcca58-666e3b15370so1852170b3a.0
        for <linux-bluetooth@vger.kernel.org>; Fri, 14 Jul 2023 15:16:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20221208; t=1689373018; x=1691965018;
        h=content-transfer-encoding:mime-version:message-id:date:subject:to
         :from:from:to:cc:subject:date:message-id:reply-to;
        bh=vcsXkmGlI/kQ/GCGOi4dgRmgWpx9/0BdM/8L5iSsqPE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20221208; t=1689373018; x=1691965018;
        h=content-transfer-encoding:mime-version:message-id:date:subject:to
         :from:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=vcsXkmGlI/kQ/GCGOi4dgRmgWpx9/0BdM/8L5iSsqPE=;
        b=
X-Gm-Message-State: ABy/qLY4LTzV4uZSS49+VUYMhx/BlQiF2piee+HI5sGn9UHBH+odGpU2
        gJUAgP4LtNU+JSe9FzaHGrD6Q5jBdXU=
X-Google-Smtp-Source: APBJJlENwGMV0hs+MTvlxiEoyMcCFAtstJWDngt3PY+Lvfuji1qpyMVoI7l2XI5Fkv+/sEXv69w5vQ==
X-Received: by 2002:a05:6a00:1988:b0:67e:18c6:d2db with SMTP id d8-20020a056a00198800b0067e18c6d2dbmr4900071pfl.28.1689373016343;
        Fri, 14 Jul 2023 15:16:56 -0700 (PDT)
Received: from lvondent-mobl4.. (c-71-236-201-58.hsd1.or.comcast.net. [71.236.201.58])
        by smtp.gmail.com with ESMTPSA id e26-20020a62aa1a000000b0065438394fa4sm7790792pff.90.2023.07.14.15.16.54
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 14 Jul 2023 15:16:55 -0700 (PDT)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH BlueZ] client: Add support for mgmt submenu
Date:   Fri, 14 Jul 2023 15:16:53 -0700
Message-Id: <20230714221653.2437444-1-luiz.dentz@gmail.com>
...
---
 Makefile.tools                  |   11 +-
 client/main.c                   |    3 +
 tools/btmgmt.c => client/mgmt.c |  173 +-
 client/mgmt.h                   |   13 +
 tools/btmgmt.c                  | 6040 +------------------------------
 5 files changed, 89 insertions(+), 6151 deletions(-)
 copy tools/btmgmt.c => client/mgmt.c (98%)
 create mode 100644 client/mgmt.h

diff --git a/Makefile.tools b/Makefile.tools
index df4cad06589a..7d9697001b75 100644
--- a/Makefile.tools
+++ b/Makefile.tools
@@ -12,9 +12,11 @@ client_bluetoothctl_SOURCES = client/main.c \
...
+			$(GLIB_LIBS) $(DBUS_LIBS) -lreadline
 ...
 if ZSH_COMPLETIONS
@@ -505,7 +507,8 @@ tools_obexctl_SOURCES = tools/obexctl.c
...
index b433a22001a3..0eac5bdf5015 100644
--- a/client/main.c
+++ b/client/main.c
@@ -33,6 +33,7 @@
...
@@ -3190,6 +3191,7 @@ int main(int argc, char *argv[])
...
@@ -3206,6 +3208,7 @@ int main(int argc, char *argv[])
...
diff --git a/tools/btmgmt.c b/client/mgmt.c
similarity index 98%
copy from tools/btmgmt.c
copy to client/mgmt.c
index 323c2671216e..c056d018a9da 100644
--- a/tools/btmgmt.c
+++ b/client/mgmt.c
@@ -33,6 +33,7 @@
...
@@ -70,28 +72,6 @@ static int pending_index = 0;
...
-
 ...
 {
 	char str[32];
@@ -106,6 +86,30 @@ static void update_prompt(uint16_t index)
...
@@ -2782,25 +2786,13 @@ static struct option find_service_options[] = {
 	{ 0, 0, 0, 0 }
 };
...
+	bt_uuid_t uuid;
 	...
 	int8_t rssi;
 	uint16_t count;
@@ -2832,16 +2824,13 @@ static void cmd_find_service(int argc, char **argv)
...
+			bt_uuid_to_le(&uuid, cp->uuids[count++]);
 		...
 		case 'r':
 			rssi = atoi(optarg);
@@ -3588,8 +3577,7 @@ static void cmd_unblock(int argc, char **argv)
...
+	bt_uuid_t uuid;
 	...
 	if (argc < 3) {
@@ -3601,16 +3589,13 @@ static void cmd_add_uuid(int argc, char **argv)
...
@@ -3624,8 +3609,7 @@ static void cmd_add_uuid(int argc, char **argv)
...
+	bt_uuid_t uuid;
 	...
 	if (argc < 2) {
@@ -3637,16 +3621,14 @@ static void cmd_remove_uuid(int argc, char **argv)
 	if (index == MGMT_INDEX_NONE)
 		index = 0;
...
+	bt_uuid_to_le(&uuid, cp.uuid);
 	...
 	if (send_cmd(mgmt, MGMT_OP_REMOVE_UUID, index, sizeof(cp), &cp,
 							class_rsp) == 0) {
@@ -4665,7 +4647,7 @@ static void cmd_add_adv(int argc, char **argv)
 	uint8_t uuid_type = 0;
...
+	bt_uuid_t uuid;
 	...
 	bool quit = true;
 	uint32_t flags = 0;
@@ -4675,7 +4657,7 @@ static void cmd_add_adv(int argc, char **argv)
...
@@ -4685,22 +4667,21 @@ static void cmd_add_adv(int argc, char **argv)
 				goto done;
 			}
...
@@ -5131,7 +5112,7 @@ static void cmd_add_ext_adv_data(int argc, char **argv)
 	size_t uuid_bytes = 0;
 	uint8_t uuid_type = 0;
 	uint8_t instance;
-	uuid_t uuid;
+	bt_uuid_t uuid;
 	...
 	bool quit = true;
 	uint16_t index;
@@ -5140,7 +5121,7 @@ static void cmd_add_ext_adv_data(int argc, char **argv)
...
@@ -5150,22 +5131,21 @@ static void cmd_add_ext_adv_data(int argc, char **argv)
 				goto done;
 			}
...
+				bt_uuid_to_le(&uuid, uuids + uuid_bytes);
 				...
 				printf("Unsupported UUID type");
@@ -5837,13 +5817,11 @@ static void cmd_select(int argc, char **argv)
...
@@ -5855,7 +5833,7 @@ static const struct bt_shell_menu monitor_menu = {
 					"features"			},
 	{ "remove",		"<handle>",
...
@@ -5863,8 +5841,9 @@ static const struct bt_shell_menu monitor_menu = {
 	{ } },
 };
...
@@ -6034,58 +6013,28 @@ static void mgmt_debug(const char *str, void *user_data)
...
index 000000000000..5a2026eab6a2
--- /dev/null
+++ b/client/mgmt.h
@@ -0,0 +1,13 @@
...
index 323c2671216e..9b7f851bd8c6 100644
--- a/tools/btmgmt.c
+++ b/tools/btmgmt.c
@@ -11,6028 +11,11 @@
 #endif
...
@@ -6062,30 +45,17 @@ int main(int argc, char *argv[])
 	int status;
