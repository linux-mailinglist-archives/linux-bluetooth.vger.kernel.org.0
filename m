...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id E1BBD2E0226
	for <lists+linux-bluetooth@lfdr.de>; Mon, 21 Dec 2020 22:43:20 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726417AbgLUVnE (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Mon, 21 Dec 2020 16:43:04 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:54528 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1725852AbgLUVnD (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Mon, 21 Dec 2020 16:43:03 -0500
Received: from mail-pj1-x1031.google.com (mail-pj1-x1031.google.com [IPv6:2607:f8b0:4864:20::1031])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BC2B7C061793
        for <linux-bluetooth@vger.kernel.org>; Mon, 21 Dec 2020 13:42:22 -0800 (PST)
Received: by mail-pj1-x1031.google.com with SMTP id m5so168859pjv.5
        for <linux-bluetooth@vger.kernel.org>; Mon, 21 Dec 2020 13:42:22 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=+vpmSDHsncwNZILd5+n9y0QFoqeMFHzrT9B6DtWlnpI=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=+vpmSDHsncwNZILd5+n9y0QFoqeMFHzrT9B6DtWlnpI=;
        b=
X-Gm-Message-State: AOAM532FJq5NwtKvs9H6YweavtMj0Jgpaq3UBvKZFN2LqL6Sa5ivZ9t/
        yUzP6iVu7AuMB2NcoEOqxS1VDr+r6Gw=
X-Google-Smtp-Source: ABdhPJyk0CL4szMSBCSSP0qiDzBsXp/XjLKNvf6UKFqyrb3UzopzI/GrybS80rpGYbIsqFMT8tvubA==
X-Received: by 2002:a17:90b:e96:: with SMTP id fv22mr19101522pjb.92.1608586941327;
        Mon, 21 Dec 2020 13:42:21 -0800 (PST)
Received: from localhost.localdomain (c-71-56-157-77.hsd1.or.comcast.net. [71.56.157.77])
        by smtp.gmail.com with ESMTPSA id 14sm17074840pjm.21.2020.12.21.13.42.20
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 21 Dec 2020 13:42:20 -0800 (PST)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH 2/3] Bluetooth: Add BTPROTO_ISO socket type
Date:   Mon, 21 Dec 2020 13:42:16 -0800
Message-Id: <20201221214217.2093485-2-luiz.dentz@gmail.com>
...
use of CONFIG_BT_ISO_SOCKET Kconfig option, it can used to
initiate/accept connection and transfer packets between userspace and
kernel similarly to how BTPROTO_SCO works.
...
---
 ...
 net/bluetooth/iso.c               | 1406 +++++++++++++++++++++++++++++
 8 files changed, 1497 insertions(+), 5 deletions(-)
 create mode 100644 include/net/bluetooth/iso.h
 create mode 100644 net/bluetooth/iso.c

diff --git a/include/net/bluetooth/bluetooth.h b/include/net/bluetooth/bluetooth.h
index 26ae85bdc589..6c7fa4ea6d45 100644
...
index 0d2fa4dc4107..06f92762013b 100644
--- a/include/net/bluetooth/hci_core.h
+++ b/include/net/bluetooth/hci_core.h
@@ -762,6 +762,21 @@ static inline void sco_recv_scodata(struct hci_conn *hcon, struct sk_buff *skb)
 }
 #endif
...
@@ -1487,8 +1502,7 @@ static inline int hci_proto_connect_ind(struct hci_dev *hdev, bdaddr_t *bdaddr,
...
index 000000000000..a4fed59dea8f
--- /dev/null
...
index bbe70c29ec62..19e45a93ff7d 100644
--- a/net/bluetooth/Kconfig
+++ b/net/bluetooth/Kconfig
@@ -86,6 +86,13 @@ config BT_ISO
 	  Connected Isochronous Stream (CIS) and Broadcast Isochronous Stream
 	  (BIS).
 
+config BT_ISO_SOCKET
+	bool "Bluetooth Isochronous (ISO) Socket support (Experimental)"
+	depends on BT_ISO
+	help
+	  Bluetooth Isochronous Socket includes support for BTPROTO_ISO socket
+	  family.
+
 config BT_6LOWPAN
...
index 1c645fba8c49..1a9b3d3a6db0 100644
...
+bluetooth-$(CONFIG_BT_ISO_SOCKET) += iso.o
 bluetooth-$(CONFIG_BT_HS) += a2mp.o amp.o
 bluetooth-$(CONFIG_BT_LEDS) += leds.o
 bluetooth-$(CONFIG_BT_MSFTEXT) += msft.o
diff --git a/net/bluetooth/af_bluetooth.c b/net/bluetooth/af_bluetooth.c
index fd4e1b40da9b..929e6e8139ce 100644
...
+	iso_exit();
 cleanup_sco:
 	sco_exit();
 cleanup_cap:
@@ -781,6 +789,9 @@ static void __exit bt_exit(void)
 {
 	mgmt_exit();
...
index fc0011c3a71d..fbd27563ecd4 100644
...
new file mode 100644
index 000000000000..adab3a368320
--- /dev/null
