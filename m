Return-Path: <linux-bluetooth+bounces-12774-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-bluetooth@lfdr.de
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id 704DEACEB75
	for <lists+linux-bluetooth@lfdr.de>; Thu,  5 Jun 2025 10:08:55 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 295967A4ACE
	for <lists+linux-bluetooth@lfdr.de>; Thu,  5 Jun 2025 08:07:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id C3E8A1F9406;
	Thu,  5 Jun 2025 08:08:36 +0000 (UTC)
X-Original-To: linux-bluetooth@vger.kernel.org
Received: from mx3.molgen.mpg.de (mx3.molgen.mpg.de [141.14.17.11])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D50C62F5B
	for <linux-bluetooth@vger.kernel.org>; Thu,  5 Jun 2025 08:08:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=141.14.17.11
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1749110916; cv=none; b=IP5hD+7WAnwoNzt4V3Z8PosE4JBOgfGrbXzWvRbhWtOo3uwrfQpc1MEV0dEfNNFg2+tpMSEJOYaiQAYUa+sG2iEAQX637Ri2tws7CCe2S2eUdGm9kDbisAO6I3wwNIfEkAz2MM6Om1w+LP3t3HCbHzX03f+oRjT7ywQNLLfaqoA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1749110916; c=relaxed/simple;
	bh=DWqeRSfqRjgkjJKeLceKb+BCcSTVTBO0Ve/3nRefPqM=;
	h=Message-ID:Date:MIME-Version:Subject:To:References:Cc:From:
	 In-Reply-To:Content-Type; b=mxHaJLdD5oDy2dlg/I0IS8V/Np1lPg5vN9o0HvTmrBSuZH5Q9E5Y3VkFeJB/PVPBGANw2E67indGaiwFbW3Vm5pGEfMwy1uX/0sQiFBnhXVdv/UuCszmir65J9LZBvK3Na7tcpsX899F1UaNsFVwjJc5tdAFJZByLvwGvw08uxo=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=molgen.mpg.de; spf=pass smtp.mailfrom=molgen.mpg.de; arc=none smtp.client-ip=141.14.17.11
Authentication-Results: smtp.subspace.kernel.org; dmarc=none (p=none dis=none) header.from=molgen.mpg.de
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=molgen.mpg.de
Received: from [172.18.197.84] (ip-185-104-138-62.ptr.icomera.net [185.104.138.62])
	(using TLSv1.3 with cipher TLS_AES_128_GCM_SHA256 (128/128 bits)
	 key-exchange X25519 server-signature RSA-PSS (2048 bits) server-digest SHA256)
	(No client certificate requested)
	(Authenticated sender: pmenzel)
	by mx.molgen.mpg.de (Postfix) with ESMTPSA id E738961E6478F;
	Thu, 05 Jun 2025 10:08:19 +0200 (CEST)
Message-ID: <55c86832-1af8-4836-adcd-152177f992bc@molgen.mpg.de>
Date: Thu, 5 Jun 2025 10:08:18 +0200
Precedence: bulk
...
Subject: Re: [PATCH BlueZ 1/1] monitor: Add support for decoding Channel
 Sounding
...
References: <20250605065913.1446880-1-magdalena.kasenberg@codecoup.pl>
 <20250605065913.1446880-2-magdalena.kasenberg@codecoup.pl>
...
Am 05.06.25 um 08:59 schrieb Magdalena Kasenberg:
...
Could you please add the section/chapter too?

Also, it’d be great if you added how to test this.
