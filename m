...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 5D9D24401E5
	for <lists+linux-bluetooth@lfdr.de>; Fri, 29 Oct 2021 20:29:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230139AbhJ2ScD (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Fri, 29 Oct 2021 14:32:03 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43588 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229968AbhJ2ScC (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Fri, 29 Oct 2021 14:32:02 -0400
Received: from mail-pf1-x435.google.com (mail-pf1-x435.google.com [IPv6:2607:f8b0:4864:20::435])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id DA730C061570
        for <linux-bluetooth@vger.kernel.org>; Fri, 29 Oct 2021 11:29:33 -0700 (PDT)
Received: by mail-pf1-x435.google.com with SMTP id a26so9957356pfr.11
        for <linux-bluetooth@vger.kernel.org>; Fri, 29 Oct 2021 11:29:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=Cc+roeYvvmNqWgSPfb8HYdh4gapquWIx0nJ2zHkw+Oc=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Cc+roeYvvmNqWgSPfb8HYdh4gapquWIx0nJ2zHkw+Oc=;
        b=
X-Gm-Message-State: AOAM5327RgGl6BNByXt8MoSw7LsRQio2k4kO2+7qwTO/fTbmaQaSm+/W
        a5Hg/4OD/nhxWexEV7rjaCe4EaDxHifL1w==
X-Google-Smtp-Source: ABdhPJzw0osAckzYNRcuduTaAnpli0Npdx4kh7oS/atIYiOPduTAuwxkgZBmRxzH1Z/oYWl2shz88A==
X-Received: by 2002:a63:7e48:: with SMTP id o8mr9539423pgn.157.1635532171805;
        Fri, 29 Oct 2021 11:29:31 -0700 (PDT)
Received: from han1-NUC8i7BEH.hsd1.or.comcast.net ([2601:1c0:6a01:d830:11f1:754d:5bb:5f40])
        by smtp.gmail.com with ESMTPSA id c3sm11634149pji.0.2021.10.29.11.29.31
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 29 Oct 2021 11:29:31 -0700 (PDT)
From:   Tedd Ho-Jeong An <hj.tedd.an@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [BlueZ PATCH v16 2/2] tools/mgmt-tester: Add LL Privacy test cases
Date:   Fri, 29 Oct 2021 11:29:29 -0700
Message-Id: <20211029182929.705682-2-hj.tedd.an@gmail.com>
...
---
 tools/mgmt-tester.c | 2564 ++++++++++++++++++++++++++++++++++++-------
 1 file changed, 2139 insertions(+), 425 deletions(-)

diff --git a/tools/mgmt-tester.c b/tools/mgmt-tester.c
index ab3c81530..207168291 100644
...
@@ -11246,13 +12703,6 @@ int main(int argc, char *argv[])
...
@@ -11671,26 +13121,6 @@ int main(int argc, char *argv[])
...
@@ -11722,20 +13152,6 @@ int main(int argc, char *argv[])
...
@@ -12297,6 +13713,55 @@ int main(int argc, char *argv[])
...
+					test_command_generic);
 	...
 	test_bredrle50("Get PHY Success", &get_phy_success,
 					NULL, test_command_generic);
@@ -12417,7 +13882,7 @@ int main(int argc, char *argv[])
...
+	test_bredrle50("zxcv Ext Adv MGMT - AD Scan Response (5.0) Success",
 				...
 				setup_ext_adv_params,
 				test_command_generic);
@@ -12674,6 +14139,255 @@ int main(int argc, char *argv[])
