...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 271A23B4D13
	for <lists+linux-bluetooth@lfdr.de>; Sat, 26 Jun 2021 08:30:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229635AbhFZGcj (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Sat, 26 Jun 2021 02:32:39 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:42804 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229630AbhFZGci (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Sat, 26 Jun 2021 02:32:38 -0400
Received: from mail-pg1-x52c.google.com (mail-pg1-x52c.google.com [IPv6:2607:f8b0:4864:20::52c])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id D1B21C061574
        for <linux-bluetooth@vger.kernel.org>; Fri, 25 Jun 2021 23:30:15 -0700 (PDT)
Received: by mail-pg1-x52c.google.com with SMTP id t9so10116942pgn.4
        for <linux-bluetooth@vger.kernel.org>; Fri, 25 Jun 2021 23:30:15 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=RrhSyqMqNfPJbFeHM2iA853lHf6ZRFaE5QRrPQtO46E=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=RrhSyqMqNfPJbFeHM2iA853lHf6ZRFaE5QRrPQtO46E=;
        b=
X-Gm-Message-State: AOAM533uBBzBbBlf7al7zPiaYaXj+zh6ra2RZzCBqNOY2Fv08i/DGZA9
        goDMdD4zpXLCc2B1sL26TqB1jAu0xrc=
X-Google-Smtp-Source: ABdhPJzGIT9cZqApP1Hu6dLxHF2oWb+sTe5R6o6mfoSm2DjfaZcy2wtGDdrpeRuiIm4P4oJu4IZBMg==
X-Received: by 2002:a65:5206:: with SMTP id o6mr13034161pgp.129.1624689014618;
        Fri, 25 Jun 2021 23:30:14 -0700 (PDT)
Received: from han1-mobl3.intel.com ([2601:1c0:6a01:d830::5820])
        by smtp.gmail.com with ESMTPSA id y21sm7587880pgc.93.2021.06.25.23.30.13
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 25 Jun 2021 23:30:13 -0700 (PDT)
From:   Tedd Ho-Jeong An <hj.tedd.an@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [RFC BlueZ PATCH v4 3/3] tools/mgmt-tester: Add LL Privacy test cases
Date:   Fri, 25 Jun 2021 23:30:10 -0700
Message-Id: <20210626063010.152987-3-hj.tedd.an@gmail.com>
...
---
 emulator/btdev.c    |    2 +-
 tools/mgmt-tester.c | 1542 +++++++++++++++++++++++++++++++++++--------
 2 files changed, 1258 insertions(+), 286 deletions(-)
...
index d2ded574e..5a6cf64c9 100644
...
+
 ...
 {
@@ -8148,6 +8098,150 @@ static const struct generic_data multi_ext_advertising_add_second = {
...
+	{
+		.opcode = BT_HCI_CMD_LE_REMOVE_ADV_SET,
+		.len = sizeof(advertising_instance0_param),
+		.param = advertising_instance0_param,
+	},
+	{
+		.opcode = BT_HCI_CMD_LE_REMOVE_ADV_SET,
+		.len = sizeof(advertising_instance1_param),
...
+	{
+		.opcode = BT_HCI_CMD_LE_REMOVE_ADV_SET,
+		.len = sizeof(advertising_instance2_param),
+		.param = advertising_instance2_param,
+	},
+};
+
...
@@ -9062,6 +9156,7 @@ static const struct generic_data start_discovery_le_1m_coded_scan_param = {
...
+
 static void set_phy_callback(uint8_t status, uint16_t length,
 					const void *param, void *user_data)
 {
@@ -9320,206 +9415,877 @@ static const struct generic_data set_exp_feat_unknown = {
...
@@ -9540,6 +10306,28 @@ static bool power_off(uint16_t index)
 	return true;
 }
...
+
 ...
 {
 	struct test_data *data = tester_get_data();
@@ -9578,6 +10366,14 @@ static void test_command_generic(const void *test_data)
 		hciemu_add_master_post_command_hook(data->hciemu,
...
@@ -10390,13 +11186,6 @@ int main(int argc, char *argv[])
...
@@ -10796,26 +11585,6 @@ int main(int argc, char *argv[])
...
@@ -10847,20 +11616,6 @@ int main(int argc, char *argv[])
...
@@ -11409,6 +12164,45 @@ int main(int argc, char *argv[])
...
+					test_command_generic);
 	...
 	test_bredrle50("Get PHY Success", &get_phy_success,
 					NULL, test_command_generic);
@@ -11674,6 +12468,184 @@ int main(int argc, char *argv[])
