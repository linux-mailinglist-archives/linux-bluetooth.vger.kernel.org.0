...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DE27334DFE2
	for <lists+linux-bluetooth@lfdr.de>; Tue, 30 Mar 2021 06:13:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229465AbhC3ENF (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Tue, 30 Mar 2021 00:13:05 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53278 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229902AbhC3EMt (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Tue, 30 Mar 2021 00:12:49 -0400
Received: from mail-yb1-xb4a.google.com (mail-yb1-xb4a.google.com [IPv6:2607:f8b0:4864:20::b4a])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 3FC47C061762
        for <linux-bluetooth@vger.kernel.org>; Mon, 29 Mar 2021 21:12:49 -0700 (PDT)
Received: by mail-yb1-xb4a.google.com with SMTP id v186so13532477ybe.5
        for <linux-bluetooth@vger.kernel.org>; Mon, 29 Mar 2021 21:12:49 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc;
        bh=7bkODnyjITkF7/5O+WEIGBIGXX9Rb8IN2fBVZYUwh70=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=7bkODnyjITkF7/5O+WEIGBIGXX9Rb8IN2fBVZYUwh70=;
        b=
X-Gm-Message-State: AOAM530CukkNCJ3Krp60QtxCQAfhm/XR+3XvMq/OQAX5607U3We/4UwJ
        WFfKjz0bsqBBhZa2VSf6ZgdnKo4GwV0nmUD3Q6zGy+kU2f7okiokCwCik7cbHDyr9nTGUcZLEB2
        p4zKGb/924690edY7k61YF5SwqRsgpws3FnFCWxujTrH+C8W6htFDB4vk6h80g5Cah6byD0QKC0
        8G
X-Google-Smtp-Source: ABdhPJwwq9TaTKWmE5XX4gVNwcoNJd1IslcoyzreYMN0lmqBuDU1eY7c61LLyyvgk3imFEQsRpqJr/9/psJM
X-Received: from apusaka-p920.tpe.corp.google.com ([2401:fa00:1:b:7941:e3e2:4e34:3f89])
 (user=apusaka job=sendgmr) by 2002:a25:a522:: with SMTP id
 h31mr43203833ybi.426.1617077568482; Mon, 29 Mar 2021 21:12:48 -0700 (PDT)
Date:   Tue, 30 Mar 2021 12:12:33 +0800
In-Reply-To: <20210330121204.Bluez.v6.1.I8797a75fcc7c1e997f177b08dc23a1df0272e0a5@changeid>
Message-Id: <20210330121204.Bluez.v6.2.I2aa61d391caefc5b67213911b5ef02b2ce191633@changeid>
Mime-Version: 1.0
References: <20210330121204.Bluez.v6.1.I8797a75fcc7c1e997f177b08dc23a1df0272e0a5@changeid>
X-Mailer: git-send-email 2.31.0.291.g576ba9dcdaf-goog
Subject: [Bluez PATCH v6 2/2] adv_monitor: merge monitors with the same pattern
...
Changes in v6:
* Fix compiler warning about braces and unused variable
...
* Remove unnecessary variable
 ...
 src/adv_monitor.c | 656 +++++++++++++++++++++++++++++++++++++---------
 1 file changed, 529 insertions(+), 127 deletions(-)

diff --git a/src/adv_monitor.c b/src/adv_monitor.c
index 131dc80039..9f04aaefbf 100644
--- a/src/adv_monitor.c
+++ b/src/adv_monitor.c
