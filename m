...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id AC07D51CC48
	for <lists+linux-bluetooth@lfdr.de>; Fri,  6 May 2022 00:47:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1386468AbiEEWvS (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Thu, 5 May 2022 18:51:18 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:34426 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1386463AbiEEWvR (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Thu, 5 May 2022 18:51:17 -0400
Received: from mail-pg1-x535.google.com (mail-pg1-x535.google.com [IPv6:2607:f8b0:4864:20::535])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id ADDC05DA3C
        for <linux-bluetooth@vger.kernel.org>; Thu,  5 May 2022 15:47:35 -0700 (PDT)
Received: by mail-pg1-x535.google.com with SMTP id r192so529115pgr.6
        for <linux-bluetooth@vger.kernel.org>; Thu, 05 May 2022 15:47:35 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=zNhmV+eF62eD/aKETRfnSHBDNZYAWTINyPAVSSjZl7U=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=zNhmV+eF62eD/aKETRfnSHBDNZYAWTINyPAVSSjZl7U=;
        b=
X-Gm-Message-State: AOAM5315Lyu8QITTBNnIEWN3PMYp1b9/zFbX6rX2McdhJCQNHicVDIgG
        XvtbTcPq/zw7y9swzlLXlc2qTdUtQNk=
X-Google-Smtp-Source: ABdhPJzJzz52Dht/msHVSyBBH4RtNBh1hMTQese6GfsXIwjVlUazQOAR0QsrJrefSOYUuKPiTvCZWw==
X-Received: by 2002:a05:6a00:1695:b0:4f7:decc:506b with SMTP id k21-20020a056a00169500b004f7decc506bmr631073pfc.7.1651790854320;
        Thu, 05 May 2022 15:47:34 -0700 (PDT)
Received: from lvondent-mobl4.. (c-71-56-157-77.hsd1.or.comcast.net. [71.56.157.77])
        by smtp.gmail.com with ESMTPSA id e21-20020a170902d39500b0015e8d4eb2aesm129651pld.248.2022.05.05.15.47.33
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 05 May 2022 15:47:33 -0700 (PDT)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH BlueZ 6/7] tools: Add isotest tool
Date:   Thu,  5 May 2022 15:47:26 -0700
Message-Id: <20220505224727.3369989-6-luiz.dentz@gmail.com>
...
---
 Makefile.tools  |    5 +-
 tools/isotest.c | 1204 +++++++++++++++++++++++++++++++++++++++++++++++
 2 files changed, 1208 insertions(+), 1 deletion(-)
 create mode 100644 tools/isotest.c

diff --git a/Makefile.tools b/Makefile.tools
index 89533ece2..7b0947ebb 100644
--- a/Makefile.tools
+++ b/Makefile.tools
@@ -216,7 +216,8 @@ noinst_PROGRAMS += tools/bdaddr tools/avinfo tools/avtest \
...
@@ -314,6 +315,8 @@ tools_gatt_service_SOURCES = tools/gatt-service.c
