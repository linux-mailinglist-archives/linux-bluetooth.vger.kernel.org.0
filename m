...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 265B2343AE9
	for <lists+linux-bluetooth@lfdr.de>; Mon, 22 Mar 2021 08:52:59 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229875AbhCVHw1 (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Mon, 22 Mar 2021 03:52:27 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:47890 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229846AbhCVHwD (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Mon, 22 Mar 2021 03:52:03 -0400
Received: from mail-qt1-x849.google.com (mail-qt1-x849.google.com [IPv6:2607:f8b0:4864:20::849])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id BB669C061574
        for <linux-bluetooth@vger.kernel.org>; Mon, 22 Mar 2021 00:52:02 -0700 (PDT)
Received: by mail-qt1-x849.google.com with SMTP id l13so20000910qtu.6
        for <linux-bluetooth@vger.kernel.org>; Mon, 22 Mar 2021 00:52:02 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc;
        bh=iuTFyI/wnucZlnmDxA32S/pZLTasIboijr/Os4RUENw=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=iuTFyI/wnucZlnmDxA32S/pZLTasIboijr/Os4RUENw=;
        b=
X-Gm-Message-State: AOAM532g7eqJP14E9sNYdOYn86hNZyYjfAs7r+FMgELyDBvP95bLj1x0
        Q9ymvtz24zU9qATwCw/xOCYZC83PTbQC1mJfpDPllITIZxK9elTh+oH4jJKK8E5W4cIaLvMg14V
        0iH1rqEQry/1bOCLvP9vUbRGpPvRh9WPsjBupapsE+EtSRDWmYSTT4O1/thQ8uacHjgY7clLcPn
        ca
X-Google-Smtp-Source: ABdhPJwMoUIP98PI41ab4AuYyeFpjAlrx3B4J/Awyb1ZaqpzlGbrDByzfojQ27qYWWQ+UHPkUSvliXRodf8x
X-Received: from apusaka-p920.tpe.corp.google.com ([2401:fa00:1:b:fdf3:9f7d:e4e3:ccad])
 (user=apusaka job=sendgmr) by 2002:ad4:4bce:: with SMTP id
 l14mr8247857qvw.30.1616399521834; Mon, 22 Mar 2021 00:52:01 -0700 (PDT)
Date:   Mon, 22 Mar 2021 15:51:43 +0800
In-Reply-To: <20210322155118.Bluez.v3.1.I8797a75fcc7c1e997f177b08dc23a1df0272e0a5@changeid>
Message-Id: <20210322155118.Bluez.v3.2.I2aa61d391caefc5b67213911b5ef02b2ce191633@changeid>
Mime-Version: 1.0
References: <20210322155118.Bluez.v3.1.I8797a75fcc7c1e997f177b08dc23a1df0272e0a5@changeid>
X-Mailer: git-send-email 2.31.0.rc2.261.g7f71774620-goog
Subject: [Bluez PATCH v3 2/2] adv_monitor: merge monitors with the same pattern
...
* Remove unnecessary variable
 ...
 src/adv_monitor.c | 646 +++++++++++++++++++++++++++++++++++++---------
 1 file changed, 519 insertions(+), 127 deletions(-)

diff --git a/src/adv_monitor.c b/src/adv_monitor.c
index 131dc80039..f38c56fafe 100644
--- a/src/adv_monitor.c
+++ b/src/adv_monitor.c
...
+
 const struct adv_monitor_type {
 	...
 	const char *name;
@@ -199,6 +228,260 @@ static void pattern_free(void *data)
 	free(pattern);
 }
...
+
 ...
 {
@@ -208,8 +491,6 @@ static void monitor_free(struct adv_monitor *monitor)
...
@@ -218,10 +499,12 @@ static void monitor_release(struct adv_monitor *monitor)
 {
...
+	    monitor->state != MONITOR_STATE_INITED &&
 		...
 		return;
@@ -234,53 +517,56 @@ static void monitor_release(struct adv_monitor *monitor)
 					NULL);
 }
...
@@ -334,7 +620,8 @@ static void monitor_state_released(void *data, void *user_data)
 {
...
+				&& monitor->state != MONITOR_STATE_ACTIVE)
 	...
 	monitor->state = MONITOR_STATE_RELEASED;
@@ -394,9 +681,6 @@ static struct adv_monitor *monitor_new(struct adv_monitor_app *app,
...
@@ -439,7 +723,7 @@ static bool parse_monitor_type(struct adv_monitor *monitor, const char *path)
...
+
 ...
 failed:
@@ -586,14 +872,14 @@ static bool parse_patterns(struct adv_monitor *monitor, const char *path)
 		return false;
 	}
...
@@ -637,21 +923,18 @@ static bool parse_patterns(struct adv_monitor *monitor, const char *path)
 		if (!pattern)
 			goto failed;
...
@@ -686,64 +1042,81 @@ static void add_adv_patterns_monitor_cb(uint8_t status, uint16_t length,
 					const void *param, void *user_data)
 {
...
@@ -753,38 +1126,40 @@ static bool monitor_send_add_pattern(struct adv_monitor *monitor)
 }
...
@@ -793,14 +1168,26 @@ static bool monitor_send_add_pattern_rssi(struct adv_monitor *monitor)
 	return success;
 }
...
@@ -822,7 +1209,7 @@ static void monitor_proxy_added_cb(GDBusProxy *proxy, void *user_data)
 		return;
 	}
...
+	if (!monitor_process(monitor)) {
 		...
 		DBG("Adv Monitor at path %s released due to invalid content",
 			path);
@@ -831,10 +1218,24 @@ static void monitor_proxy_added_cb(GDBusProxy *proxy, void *user_data)
...
@@ -1064,54 +1465,38 @@ static const GDBusPropertyTable adv_monitor_properties[] = {
 	{ }
 };
...
@@ -1129,8 +1514,8 @@ static void adv_monitor_removed_callback(uint16_t index, uint16_t length,
 		return;
 	}
...
+	queue_foreach(manager->merged_patterns, remove_merged_pattern, &handle);
 	...
 	DBG("Adv Monitor removed event with handle 0x%04x processed",
 		ev->monitor_handle);
@@ -1154,6 +1539,7 @@ static struct btd_adv_monitor_manager *manager_new(
...
@@ -1168,6 +1554,7 @@ static void manager_free(struct btd_adv_monitor_manager *manager)
...
@@ -1274,6 +1661,7 @@ static void adv_match_per_monitor(void *data, void *user_data)
 {
 	struct adv_monitor *monitor = data;
...
@@ -1283,8 +1671,12 @@ static void adv_match_per_monitor(void *data, void *user_data)
 	if (monitor->state != MONITOR_STATE_ACTIVE)
 		return;
