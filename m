...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 84A2F54FFCB
	for <lists+linux-bluetooth@lfdr.de>; Sat, 18 Jun 2022 00:17:35 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235162AbiFQWRd (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Fri, 17 Jun 2022 18:17:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59690 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S245162AbiFQWRX (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Fri, 17 Jun 2022 18:17:23 -0400
Received: from mail-pj1-x102d.google.com (mail-pj1-x102d.google.com [IPv6:2607:f8b0:4864:20::102d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E95615D1A4
        for <linux-bluetooth@vger.kernel.org>; Fri, 17 Jun 2022 15:17:19 -0700 (PDT)
Received: by mail-pj1-x102d.google.com with SMTP id k12-20020a17090a404c00b001eaabc1fe5dso5721520pjg.1
        for <linux-bluetooth@vger.kernel.org>; Fri, 17 Jun 2022 15:17:19 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=w+0sFNqXRtRsR8K7yxHP9pTTIOQDAkaDEK4PDNf8VT0=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=w+0sFNqXRtRsR8K7yxHP9pTTIOQDAkaDEK4PDNf8VT0=;
        b=
X-Gm-Message-State: AJIora8prHuraOQMb/E/cv5olrfJH5iYlaqLCJ9MuwsVnfIAHLicipfl
        G9zB9w3TFRCQ6FqybbOhbMXdcmbY0MI=
X-Google-Smtp-Source: AGRyM1vY8mmWo18dyIOgNZdD4opoXGhSWGp3xAIlOFO8s+RYqZSKPZRlDbWKNWAjaR4TtxlUy77faA==
X-Received: by 2002:a17:90a:f015:b0:1ec:80f4:59d0 with SMTP id bt21-20020a17090af01500b001ec80f459d0mr2944937pjb.57.1655504237965;
        Fri, 17 Jun 2022 15:17:17 -0700 (PDT)
Received: from lvondent-mobl4.. (c-71-56-157-77.hsd1.or.comcast.net. [71.56.157.77])
        by smtp.gmail.com with ESMTPSA id jc21-20020a17090325d500b0016184e7b013sm4117261plb.36.2022.06.17.15.17.16
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 17 Jun 2022 15:17:17 -0700 (PDT)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH v3 4/7] Bluetooth: Add initial implementation of BIS connections
Date:   Fri, 17 Jun 2022 15:17:09 -0700
Message-Id: <20220617221712.1394014-4-luiz.dentz@gmail.com>
...
---
 ...
 13 files changed, 1331 insertions(+), 126 deletions(-)
...
index 9896e7fbe254..197e97c9c5da 100644
...
index d540849428ef..7484759fe95a 100644
...
-
 struct hci_conn *hci_bind_cis(struct hci_dev *hdev, bdaddr_t *dst,
 			      __u8 dst_type, struct bt_iso_qos *qos)
 {
@@ -1598,6 +1880,178 @@ static void hci_iso_qos_setup(struct hci_dev *hdev, struct hci_conn *conn,
...
index 77dfe9aae6ab..65dc34ddaf50 100644
...
index c6274a0e0e97..0215a40ec331 100644
...
index ea6d19ea7aef..d0c51eebf3e5 100644
...
@@ -5474,3 +5698,25 @@ int hci_le_remove_cig_sync(struct hci_dev *hdev, u8 handle)
...
index 2847223f7efb..8cca1eb574c0 100644
