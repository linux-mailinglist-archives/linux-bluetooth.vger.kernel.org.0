Return-Path: <linux-bluetooth+bounces-18593-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id UENPJ8k6emlN4wEAu9opvQ
	(envelope-from <linux-bluetooth+bounces-18593-lists+linux-bluetooth=lfdr.de@vger.kernel.org>)
	for <lists+linux-bluetooth@lfdr.de>; Wed, 28 Jan 2026 17:35:21 +0100
X-Original-To: lists+linux-bluetooth@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 93042A5D7F
	for <lists+linux-bluetooth@lfdr.de>; Wed, 28 Jan 2026 17:35:20 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id 7239632A2C08
	for <lists+linux-bluetooth@lfdr.de>; Wed, 28 Jan 2026 15:56:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 00ECF30C635;
	Wed, 28 Jan 2026 15:56:10 +0000 (UTC)
X-Original-To: linux-bluetooth@vger.kernel.org
Received: from relay4-d.mail.gandi.net (relay4-d.mail.gandi.net [217.70.183.196])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 388B62857CD
	for <linux-bluetooth@vger.kernel.org>; Wed, 28 Jan 2026 15:56:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.196
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1769615769; cv=none; b=np5IHX8ytbJKvZ5kgD7FhUtHRpKGfjjV2KozwPCc2wTKARAETwnduRCDW/VQhkHvPI+AXsp9UlmdMv05W3VCvZ0dODJu33yhD2gjCTmdiF3/5iT4xTdy3liQ2ZtStHY5gg904B96ul+JiWqS6ncLleRtEUz1d5gxHH8GI+cFxUU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1769615769; c=relaxed/simple;
	bh=PoNH9BOKlWmaBAJGLNuwY3ux9bNnyyWFF4GxeYo9XrA=;
	h=From:To:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=dgbfnvRURR2iAIR9qm3T2KH4MOEep7X+3Ydv70PHPohkcwKmbEa1WRUJglcgWyoD5jaNgttmW8WTRa47Yw+ABSna03cm777EGhmOhE1WKYbvRQu24HNixOksAZcfqkMXj9owVBnZza5sPfgIGSmvA2+8LqqQ0ybX8knsd74ZDYc=
...
Received: by mail.gandi.net (Postfix) with ESMTPSA id 1FFD143FF5
	for <linux-bluetooth@vger.kernel.org>; Wed, 28 Jan 2026 15:55:58 +0000 (UTC)
From: Bastien Nocera <hadess@hadess.net>
To: linux-bluetooth@vger.kernel.org
Subject: [PATCH BlueZ v6 05/20] build: Add meson build system
Date: Wed, 28 Jan 2026 16:11:43 +0100
Message-ID: <20260128155548.2025252-6-hadess@hadess.net>
...
X-GND-Score: 0
X-GND-Cause: 
 hgvlhdrohhrgh
X-GND-State: clean
...
X-Spamd-Result: default: False [0.04 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-18593-lists,linux-bluetooth=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
	...
	TO_DN_NONE(0.00)[];
	R_DKIM_NA(0.00)[];
	DBL_BLOCKED_OPENRESOLVER(0.00)[hadess.net:mid,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,0.0.0.0:email,rst.in:url,bluezutils.py:url,meson.build:url,sap_client.py:url]
X-Rspamd-Queue-Id: 93042A5D7F
...
---
 ...
 tools/meson.build            | 323 +++++++++++++++++++++++++++++++++++
 tools/mpris-proxy.service.in |   2 +-
 unit/meson.build             | 125 ++++++++++++++
 24 files changed, 1803 insertions(+), 1 deletion(-)
...
new file mode 100644
index 000000000000..b62918db64b8
--- /dev/null
+++ b/doc/meson.build
@@ -0,0 +1,169 @@
+man_pages = [
...
new file mode 100644
index 000000000000..335c721b3efc
--- /dev/null
+++ b/meson_options.txt
@@ -0,0 +1,54 @@
...
new file mode 100644
index 000000000000..74c272351a3c
--- /dev/null
...
new file mode 100644
index 000000000000..17ac40816721
--- /dev/null
+++ b/tools/meson.build
@@ -0,0 +1,323 @@
+tools_man_pages = [
