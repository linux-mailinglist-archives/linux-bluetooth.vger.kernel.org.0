...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 78338570E56
	for <lists+linux-bluetooth@lfdr.de>; Tue, 12 Jul 2022 01:35:45 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229990AbiGKXfo (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Mon, 11 Jul 2022 19:35:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52966 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229743AbiGKXfo (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Mon, 11 Jul 2022 19:35:44 -0400
Received: from mail-pg1-x532.google.com (mail-pg1-x532.google.com [IPv6:2607:f8b0:4864:20::532])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E70A52B18A
        for <linux-bluetooth@vger.kernel.org>; Mon, 11 Jul 2022 16:35:40 -0700 (PDT)
Received: by mail-pg1-x532.google.com with SMTP id 23so6061354pgc.8
        for <linux-bluetooth@vger.kernel.org>; Mon, 11 Jul 2022 16:35:40 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=MipFSkHjfq5uNgUWyw47TJ2zefNtNyt3QATheojIzMo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=MipFSkHjfq5uNgUWyw47TJ2zefNtNyt3QATheojIzMo=;
        b=
X-Gm-Message-State: AJIora/HKACNxj8VlnhiSvs8hxvtE5FFD2CL9/vWIJQZDgYi5mIn4+Wl
        lAWnMWlJn/iUr1PAVT4n2X3beL295Iw=
X-Google-Smtp-Source: AGRyM1vxxnQtS/i90iEp1FWIl30JyZWkaT+MpfTQBMuxB+73adtN5AmPgov5lOVNFMlrnq/oCFS+ug==
X-Received: by 2002:a05:6a00:1911:b0:525:9ffe:cffc with SMTP id y17-20020a056a00191100b005259ffecffcmr20378163pfi.54.1657582539210;
        Mon, 11 Jul 2022 16:35:39 -0700 (PDT)
Received: from lvondent-mobl4.. (c-71-56-157-77.hsd1.or.comcast.net. [71.56.157.77])
        by smtp.gmail.com with ESMTPSA id q93-20020a17090a17e600b001e33e264fd6sm5446281pja.40.2022.07.11.16.35.38
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 11 Jul 2022 16:35:38 -0700 (PDT)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH v7 2/7] Bluetooth: Add initial implementation of CIS connections
Date:   Mon, 11 Jul 2022 16:35:30 -0700
Message-Id: <20220711233535.3134546-2-luiz.dentz@gmail.com>
...
index baaf2fb969c3..05256fb8cd21 100644
--- a/net/bluetooth/hci_core.c
+++ b/net/bluetooth/hci_core.c
@@ -615,7 +615,10 @@ static int hci_dev_do_reset(struct hci_dev *hdev)
...
@@ -3187,9 +3190,117 @@ void hci_send_sco(struct hci_conn *conn, struct sk_buff *skb)
...
+
 static struct hci_conn *hci_low_sent(struct hci_dev *hdev, __u8 type,
 				     int *quote)
 {
@@ -3222,29 +3333,7 @@ static struct hci_conn *hci_low_sent(struct hci_dev *hdev, __u8 type,
...
+	hci_quote_sent(conn, num, quote);
 	...
 	return conn;
@@ -3278,7 +3367,7 @@ static struct hci_chan *hci_chan_sent(struct hci_dev *hdev, __u8 type,
...
@@ -3328,27 +3417,8 @@ static struct hci_chan *hci_chan_sent(struct hci_dev *hdev, __u8 type,
 	if (!chan)
 		return NULL;
...
@@ -3637,18 +3707,46 @@ static void hci_sched_le(struct hci_dev *hdev)
...
@@ -3731,6 +3829,39 @@ static void hci_scodata_packet(struct hci_dev *hdev, struct sk_buff *skb)
 	kfree_skb(skb);
 }
...
+
 ...
 {
 	struct sk_buff *skb;
@@ -3885,6 +4016,11 @@ static void hci_rx_work(struct work_struct *work)
...
index 0f6b557dcd36..95b391ed84ec 100644
...
@@ -5424,3 +5460,14 @@ int hci_le_create_conn_sync(struct hci_dev *hdev, struct hci_conn *conn)
