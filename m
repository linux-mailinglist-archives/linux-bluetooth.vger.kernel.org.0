...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 48EB6437F78
	for <lists+linux-bluetooth@lfdr.de>; Fri, 22 Oct 2021 22:48:37 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S234348AbhJVUuw (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Fri, 22 Oct 2021 16:50:52 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:55528 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S234339AbhJVUuv (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Fri, 22 Oct 2021 16:50:51 -0400
Received: from mail-pg1-x532.google.com (mail-pg1-x532.google.com [IPv6:2607:f8b0:4864:20::532])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id B32B6C061764
        for <linux-bluetooth@vger.kernel.org>; Fri, 22 Oct 2021 13:48:33 -0700 (PDT)
Received: by mail-pg1-x532.google.com with SMTP id q5so4361315pgr.7
        for <linux-bluetooth@vger.kernel.org>; Fri, 22 Oct 2021 13:48:33 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=06fbfqkcoPPGcEELCi/PeWrT5d/82PdKMItKbaRLflY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=06fbfqkcoPPGcEELCi/PeWrT5d/82PdKMItKbaRLflY=;
        b=
X-Gm-Message-State: AOAM532JYKJxkK/E/PWUnGNnRdnQ9uHXU/goAM5t0jg0n0uiq6vYGD2E
        DaoO0aevRzif7eEYDROwe0qRalSI7Rrcow==
X-Google-Smtp-Source: ABdhPJxn97nN2r08APx4AhsXEOsO/dOY06Mbdw0/ZiwCBgo3yPtB0BxprRrGnUIYVPfBeTtd3vnySg==
X-Received: by 2002:a05:6a00:ccb:b0:44c:eb4b:f24e with SMTP id b11-20020a056a000ccb00b0044ceb4bf24emr2153984pfv.16.1634935711745;
        Fri, 22 Oct 2021 13:48:31 -0700 (PDT)
Received: from han1-NUC8i7BEH.hsd1.or.comcast.net ([2601:1c0:6a01:d830:6966:f5b2:62ac:cf35])
        by smtp.gmail.com with ESMTPSA id z19sm10285654pfj.156.2021.10.22.13.48.31
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 22 Oct 2021 13:48:31 -0700 (PDT)
From:   Tedd Ho-Jeong An <hj.tedd.an@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [RFC BlueZ PATCH v14 5/5] tools/mgmt-tester: Add LL Privacy test cases
Date:   Fri, 22 Oct 2021 13:48:25 -0700
Message-Id: <20211022204825.397952-5-hj.tedd.an@gmail.com>
...
---
 tools/mgmt-tester.c | 2133 +++++++++++++++++++++++++++++++++++++------
 1 file changed, 1848 insertions(+), 285 deletions(-)

diff --git a/tools/mgmt-tester.c b/tools/mgmt-tester.c
index 1ccce0ad6..1fab5a9db 100644
...
+
 static void set_phy_callback(uint8_t status, uint16_t length,
 					const void *param, void *user_data)
 {
@@ -9815,203 +9950,1121 @@ static const struct generic_data set_exp_feat_unknown = {
...
+
 	mgmt_send(data->mgmt, MGMT_OP_SET_POWERED, data->mgmt_index,
 					sizeof(param), param,
 					setup_powered_callback, NULL, NULL);
@@ -10025,14 +11078,36 @@ static bool power_off(uint16_t index)
 	if (sk < 0)
 		return false;
...
@@ -10073,6 +11148,14 @@ static void test_command_generic(const void *test_data)
 		hciemu_add_central_post_command_hook(data->hciemu,
...
@@ -10219,6 +11302,240 @@ static void test_pairing_acceptor(const void *test_data)
...
+
 static void connected_event(uint16_t index, uint16_t length, const void *param,
 							void *user_data)
 {
@@ -11246,13 +12563,6 @@ int main(int argc, char *argv[])
...
@@ -11671,26 +12981,6 @@ int main(int argc, char *argv[])
...
@@ -11722,20 +13012,6 @@ int main(int argc, char *argv[])
...
@@ -12297,6 +13573,55 @@ int main(int argc, char *argv[])
...
+					test_command_generic);
 	...
 	test_bredrle50("Get PHY Success", &get_phy_success,
 					NULL, test_command_generic);
@@ -12417,7 +13742,7 @@ int main(int argc, char *argv[])
...
+	test_bredrle50("zxcv Ext Adv MGMT - AD Scan Response (5.0) Success",
 				...
 				setup_ext_adv_params,
 				test_command_generic);
@@ -12674,6 +13999,244 @@ int main(int argc, char *argv[])
...
+	 * Expect: Receive Unpair event
+	 */
+	test_bredrle50_full("LL Privacy - Unpair 2 (Remove RL)",
+				&ll_privacy_unpair_2,
+				NULL,
