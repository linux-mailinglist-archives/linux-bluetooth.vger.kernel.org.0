...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 05DB2520751
	for <lists+linux-bluetooth@lfdr.de>; Tue, 10 May 2022 00:06:08 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S231232AbiEIWJY (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Mon, 9 May 2022 18:09:24 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:41270 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231131AbiEIWJW (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Mon, 9 May 2022 18:09:22 -0400
Received: from mga06.intel.com (mga06b.intel.com [134.134.136.31])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id A4AF82A83E6
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  ...
  bh=GrmknmPXRrK2ueFhXHGsoyiMXMwNVq0j/cd3CXO3Xb0=;
  b=Qt/EY8J8PO+2d8S0WFO+m3q2wwugAx44VcQH/GN02THrZcuPRylGw98x
   C5lWEUC37v+9unprPkYCirsDk3KfYKXcVA9CIi0Iu3ue864NelmyTi4ZW
   7vJAZ8qqvhuQ9wLLqpu2Kf9+kacGpKFIkFchLrw9JLiVV9kzOiZ2uW25O
   OIpO9rVTxW7Fotp9VK459ReXVDvohUC2m7ifiA1ESjI01Nd75+C5NazO+
   OFKF+Zj0kP9y21mUGPXXYsaTiq6e6M/DpxnLrGbvtqj19QzIa3gplhUG5
   H/6dGWYqWsnLckZEW+sDkcx5mtQ7/sg4f9dgJU9YAdXLBN/sJQBjMra5G
   w==;
X-IronPort-AV: E=McAfee;i="6400,9594,10342"; a="329776689"
X-IronPort-AV: E=Sophos;i="5.91,212,1647327600"; 
   d="scan'208";a="329776689"
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by orsmga104.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 09 May 2022 15:05:22 -0700
X-IronPort-AV: E=Sophos;i="5.91,212,1647327600"; 
   d="scan'208";a="657329492"
...
Subject: [PATCH v2 1/2] Bluetooth: Implement support for Mesh
Date:   Mon,  9 May 2022 15:05:11 -0700
Message-Id: <20220509220512.482695-2-brian.gix@intel.com>
...
---
 ...
 net/bluetooth/mgmt.c              | 451 +++++++++++++++++++++++++++++-
 net/bluetooth/mgmt_util.c         |  69 +++++
 net/bluetooth/mgmt_util.h         |  17 ++
 14 files changed, 818 insertions(+), 79 deletions(-)
...
index 64d3a63759a8..ff931fb78f82 100644
...
index 0270e597c285..1274d7327d51 100644
...
index f4afe482e300..8489e08bfd08 100644
...
@@ -2285,6 +2327,21 @@ static int active_scan(struct hci_request *req, unsigned long opt)
 	return 0;
 }
...
+
 ...
 {
 	int err;
@@ -2339,8 +2396,16 @@ static void start_discovery(struct hci_dev *hdev, u8 *status)
 		break;
 	case DISCOV_TYPE_LE:
...
@@ -2568,7 +2633,7 @@ static int powered_update_hci(struct hci_request *req, unsigned long opt)
...
+			if (use_ext_adv(hdev)) {
 				err = __hci_req_setup_ext_adv_instance(req,
 								       0x00);
 				if (!err)
@@ -2581,7 +2646,7 @@ static int powered_update_hci(struct hci_request *req, unsigned long opt)
 			}
...
index a6ada9dcede5..5dad989c8bbb 100644
...
index d2d390534e54..aebd579fddba 100644
...
@@ -2029,6 +2093,7 @@ static int set_le_sync(struct hci_dev *hdev, void *data)
 	u8 val = !!cp->val;
 	int err;
...
+
 	if (!val) {
 		if (hci_dev_test_flag(hdev, HCI_LE_ADV))
 			hci_disable_advertising_sync(hdev);
@@ -2047,7 +2112,7 @@ static int set_le_sync(struct hci_dev *hdev, void *data)
...
@@ -2064,6 +2129,281 @@ static int set_le_sync(struct hci_dev *hdev, void *data)
 	return err;
 }
...
@@ -9888,3 +10304,22 @@ void mgmt_exit(void)
 {
...
index b69cfed62088..78ef3746e044 100644
...
index 98e40395a383..4f42350f0478 100644
