Return-Path: <linux-bluetooth+bounces-2905-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-bluetooth@lfdr.de
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id E4050890152
	for <lists+linux-bluetooth@lfdr.de>; Thu, 28 Mar 2024 15:10:43 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 033F31C2B616
	for <lists+linux-bluetooth@lfdr.de>; Thu, 28 Mar 2024 14:10:43 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 788AA12D209;
	Thu, 28 Mar 2024 14:09:35 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="gLi2i84B"
X-Original-To: linux-bluetooth@vger.kernel.org
Received: from mail-lj1-f173.google.com (mail-lj1-f173.google.com [209.85.208.173])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id AB15E28366
	for <linux-bluetooth@vger.kernel.org>; Thu, 28 Mar 2024 14:09:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.173
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711634974; cv=none; b=sQxU98U1zPHE2a2JL1HuA9RDFVmRNHdfDOzdJa6wseuQ9FL6iBhii6YKkZmaiIRdhMNMKxAXwxIpL1iUpVJHf9r3ilKIjCHdy2OZthZFJSsxHeVDwMkKelBskEg1oDK80Hi+mrUwn/5LG2lgkU195BXxcM7CMTplwaIuTuWSsR8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711634974; c=relaxed/simple;
	bh=uIptezlVtZ30okhgFl1jFIFs30NS8iE6qNFI47P+ntk=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=KQWB7pVOPHzekO/6bf2QRvMVbqIl3aC5ItN7JwmG6KBRgVps7BLJFcbWIAz2cl0uXojCAB8hEzrpAUjGDgcqicRth7WTqPP+Mi0ezVbE3FfrvVXJwKBlAXYg1V6t5tJX7O8UD8RXikdMP4z8P7etMSyABTABNyB0dFj8nN5WEEg=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=gLi2i84B; arc=none smtp.client-ip=209.85.208.173
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-lj1-f173.google.com with SMTP id 38308e7fff4ca-2d4886a1cb4so11992311fa.0
        for <linux-bluetooth@vger.kernel.org>; Thu, 28 Mar 2024 07:09:30 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1711634969; x=1712239769; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=aw0ijftYnNo4IOOoi/eHDg5+DtldG7As3Rxyt8IsZ00=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1711634969; x=1712239769;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=aw0ijftYnNo4IOOoi/eHDg5+DtldG7As3Rxyt8IsZ00=;
        b=
X-Gm-Message-State: AOJu0Yxy6V6CZIVzjQjPbFp8l4JDbKzNa33ok4neKVIa9+/jgb9T7pL/
	fdpzXCZFb2Og8GO8cPVjbVGi5XqKdxg8pknfS3UTmbfFNmOe/vvZuYIxe7iWJ2oIVl3wOQw/RnK
	swbopfncqAeNnZAFLkO9ckMsxO8dpqHxb0hg=
X-Google-Smtp-Source: AGHT+IE66i7HZWdwlO+f/2Wz91CQmeRZ0/5TeVd9DysgNOgLVAQF1RtjkCdAWjQQpB4xDPhzc4fFF/+4186eHeQilVs=
X-Received: by 2002:a2e:9b95:0:b0:2d6:b98d:c868 with SMTP id
 z21-20020a2e9b95000000b002d6b98dc868mr2837047lji.14.1711634968272; Thu, 28
 Mar 2024 07:09:28 -0700 (PDT)
Precedence: bulk
...
Date: Thu, 28 Mar 2024 10:09:15 -0400
Message-ID: <CABBYNZK7MUyn1df9dTnu3=+7i5amewDY+kkT+-9ydtDmVcm-kQ@mail.gmail.com>
...
> +static inline void btintel_pcie_hci_dump(const char *p, const void *b, i=
nt s)
> +{
...
> +       BT_DBG("[TXQ] tfd_index:%u num_txq:%u cmpl_cnt:%u immediate_cmpl:=
0x%x",
...
> +}
> +
> +/* Set the doorbell for RXQ to notify the device that @index(actually in=
dex-1)
...
> +       btintel_pcie_wr_reg32(data, CSR_FUNC_CTRL_REG, CSR_FUNC_CTRL_SW_R=
ESET);
> +}
> +
> +/* This function enables BT function by setting CSR_FUNC_CTRL_MAC_INIT b=
it in
> + * CSR_FUNC_CTRL_REG register and wait for MSI-X with MSIX_HW_INT_CAUSES=
_GP0.
> + * Then the host reads firmware version from CSR_F2D_MBX and the boot st=
age
...
> + * CSR_MSIX_HW_INT_CAUSES) which is sent for boot stage and image respon=
se.
> + */
...
> +                       BT_ERR("[TXQ] out of range: (0x%x)", urbd0->tfd_i=
ndex);
> +                       return;
> +               }
> +
...
> +               memcpy(skb_put(skb, HCI_ACL_HDR_SIZE), buf, HCI_ACL_HDR_S=
IZE);
...
> +               memcpy(skb_put(skb, HCI_SCO_HDR_SIZE), buf, HCI_SCO_HDR_S=
IZE);
...
> +}
> +
> +/* This function handles the MSI-X interrupt for rx queue 1 which is for=
 RX
> + */
...
> +        */
> +       btintel_pcie_wr_reg32(data, CSR_MSIX_AUTOMASK_ST, BIT(entry->entr=
y));
> +
> +       return IRQ_HANDLED;
> +}
> +
> +/* This function requests the irq for msix and registers the handlers pe=
r irq.
...
er
> + * need to call this function again to configure it again since the mask=
s
...
> +       data->fh_init_mask =3D ~btintel_pcie_rd_reg32(data, CSR_MSIX_FH_I=
NT_MASK);
> +       data->hw_init_mask =3D ~btintel_pcie_rd_reg32(data, CSR_MSIX_HW_I=
NT_MASK);
...
> +
> +       BT_DBG("alloc bufs: p=3D0x%llx v=3D0x%p", txq->buf_p_addr, txq->b=
uf_v_addr);
> +
...
> +
> +       BT_DBG("alloc bufs: p=3D0x%llx v=3D0x%p", rxq->buf_p_addr, rxq->b=
uf_v_addr);
> +
> +       /* Setup the allocated DMA buffer to bufs. Each data_buf should
> +        * have virtual address and physical address
