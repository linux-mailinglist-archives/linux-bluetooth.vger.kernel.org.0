...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 68ADE19AF32
	for <lists+linux-bluetooth@lfdr.de>; Wed,  1 Apr 2020 17:59:32 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1733180AbgDAP7b (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Wed, 1 Apr 2020 11:59:31 -0400
Received: from coyote.holtmann.net ([212.227.132.17]:32964 "EHLO
        mail.holtmann.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1733088AbgDAP7b (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Wed, 1 Apr 2020 11:59:31 -0400
Received: from localhost.localdomain (p4FEFC5A7.dip0.t-ipconnect.de [79.239.197.167])
        by mail.holtmann.org (Postfix) with ESMTPSA id 1BA8ECECDE
        for <linux-bluetooth@vger.kernel.org>; Wed,  1 Apr 2020 18:09:03 +0200 (CEST)
From:   Marcel Holtmann <marcel@holtmann.org>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH v3 2/3] Bluetooth: Add framework for Microsoft vendor extension
Date:   Wed,  1 Apr 2020 17:59:22 +0200
Message-Id: <20200401155923.485359-2-marcel@holtmann.org>
...
index 228b5021060c..2f3275f1d1c4 100644
--- a/include/net/bluetooth/hci_core.h
+++ b/include/net/bluetooth/hci_core.h
@@ -486,6 +486,11 @@ struct hci_dev {
...
@@ -1118,6 +1123,14 @@ int hci_recv_frame(struct hci_dev *hdev, struct sk_buff *skb);
...
index 331759878b3c..151603d269f5 100644
...
@@ -1567,6 +1568,8 @@ static int hci_dev_do_open(struct hci_dev *hdev)
...
+
 	...
 	if (!ret) {
@@ -1762,6 +1765,8 @@ int hci_dev_do_close(struct hci_dev *hdev)
...
index ca7a00e9312a..dcfd8cdc9ab0 100644
