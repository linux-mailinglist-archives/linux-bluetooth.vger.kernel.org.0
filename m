...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 15DA051CC7E
	for <lists+linux-bluetooth@lfdr.de>; Fri,  6 May 2022 01:07:31 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1386589AbiEEXJr (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Thu, 5 May 2022 19:09:47 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46484 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1386595AbiEEXJo (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Thu, 5 May 2022 19:09:44 -0400
Received: from mail-il1-x136.google.com (mail-il1-x136.google.com [IPv6:2607:f8b0:4864:20::136])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0C1455EDCB
        for <linux-bluetooth@vger.kernel.org>; Thu,  5 May 2022 16:06:01 -0700 (PDT)
Received: by mail-il1-x136.google.com with SMTP id h11so3822538ila.5
        for <linux-bluetooth@vger.kernel.org>; Thu, 05 May 2022 16:06:01 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=hj0Sye0kbOoaNpk7Fui2cqMH+i2OzQgJ49f352a6+78=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=hj0Sye0kbOoaNpk7Fui2cqMH+i2OzQgJ49f352a6+78=;
        b=
X-Gm-Message-State: AOAM533Uoj3rfrZDHv9BeLQcSnALpWj2dJl5s1042x+Cx45Syhcqaz+p
        2ts3WUMawZTzGucXM651bF0Ms3/ad54=
X-Google-Smtp-Source: ABdhPJx7Ywm9/OnYVfUgwA/BNGNGf5NYK2wEBrD8xSe7vxwIDveb8BQVw8FJP3/vYSxutnVsAQeZfQ==
X-Received: by 2002:a92:cd8d:0:b0:2cd:81ce:79bd with SMTP id r13-20020a92cd8d000000b002cd81ce79bdmr164172ilb.252.1651791958882;
        Thu, 05 May 2022 16:05:58 -0700 (PDT)
Received: from lvondent-mobl4.. (c-71-56-157-77.hsd1.or.comcast.net. [71.56.157.77])
        by smtp.gmail.com with ESMTPSA id l10-20020a92d8ca000000b002cde6e352bfsm780757ilo.9.2022.05.05.16.05.56
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Thu, 05 May 2022 16:05:57 -0700 (PDT)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH 5/8] Bluetooth: Add initial implementation of BIS connections
Date:   Thu,  5 May 2022 16:05:47 -0700
Message-Id: <20220505230550.3450617-5-luiz.dentz@gmail.com>
...
index aeb601524d24..f34840cc50ed 100644
...
index 4aebd1015100..906829572f3d 100644
...
index 510847588e9b..c377d6d3ad21 100644
...
-
 struct hci_conn *hci_bind_cis(struct hci_dev *hdev, bdaddr_t *dst,
 			      __u8 dst_type, struct bt_iso_qos *qos)
 {
@@ -1411,7 +1693,6 @@ struct hci_conn *hci_bind_cis(struct hci_dev *hdev, bdaddr_t *dst,
 		if (!cis) {
 			return ERR_PTR(-ENOMEM);
 		}
...
@@ -1590,6 +1871,179 @@ static void hci_iso_qos_setup(struct hci_dev *hdev, struct hci_conn *conn,
...
index be37f84a97c6..66c7a48487f6 100644
...
index 23699b025774..371ad3642d08 100644
--- a/net/bluetooth/hci_event.c
+++ b/net/bluetooth/hci_event.c
@@ -3892,6 +3892,69 @@ static u8 hci_cc_le_setup_iso_path(struct hci_dev *hdev, void *data,
 	return rp->status;
 }
...
+
 ...
 { \
 	.op = _op, \
@@ -4065,6 +4128,9 @@ static const struct hci_cc {
...
@@ -4201,6 +4267,7 @@ static const struct hci_cs {
...
@@ -6422,6 +6489,39 @@ static void hci_le_ext_adv_report_evt(struct hci_dev *hdev, void *data,
 	hci_dev_unlock(hdev);
 }
...
+
 static void hci_le_remote_feat_complete_evt(struct hci_dev *hdev, void *data,
 					    struct sk_buff *skb)
 {
@@ -6774,6 +6874,105 @@ static void hci_le_cis_req_evt(struct hci_dev *hdev, void *data,
 	hci_dev_unlock(hdev);
 }
...
+
 ...
 [_op] = { \
 	.func = _func, \
@@ -6834,6 +7033,10 @@ static const struct hci_le_ev {
...
@@ -6843,6 +7046,21 @@ static const struct hci_le_ev {
...
@@ -6885,7 +7103,6 @@ static void hci_le_meta_evt(struct hci_dev *hdev, void *data,
 	if (!data)
 		return;
...
index f4afe482e300..b6b9335ba9ea 100644
--- a/net/bluetooth/hci_request.c
+++ b/net/bluetooth/hci_request.c
@@ -825,10 +825,9 @@ static bool adv_cur_instance_is_scannable(struct hci_dev *hdev)
...
index e8c27f65a371..a58ce19cf995 100644
...
index bf653e615630..716c9a8e4493 100644
--- a/net/bluetooth/mgmt.c
+++ b/net/bluetooth/mgmt.c
@@ -8149,7 +8149,7 @@ static int add_advertising(struct sock *sk, struct hci_dev *hdev,
...
@@ -8200,7 +8200,7 @@ static int add_advertising(struct sock *sk, struct hci_dev *hdev,
...
@@ -8208,7 +8208,7 @@ static int add_advertising(struct sock *sk, struct hci_dev *hdev,
...
+	if (IS_ERR(adv)) {
 		err = mgmt_cmd_status(sk, hdev->id, MGMT_OP_ADD_ADVERTISING,
 				      MGMT_STATUS_FAILED);
 		goto unlock;
@@ -8339,6 +8339,7 @@ static int add_ext_adv_params(struct sock *sk, struct hci_dev *hdev,
...
+	struct adv_info *adv;
 	...
 	u16 timeout, duration;
 	u8 status;
@@ -8408,11 +8409,11 @@ static int add_ext_adv_params(struct sock *sk, struct hci_dev *hdev,
 		   HCI_ADV_TX_POWER_NO_PREFERENCE;
