...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5729611D76E
	for <lists+linux-bluetooth@lfdr.de>; Thu, 12 Dec 2019 20:48:46 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730654AbfLLTsi (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Thu, 12 Dec 2019 14:48:38 -0500
Received: from mga01.intel.com ([192.55.52.88]:27722 "EHLO mga01.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1730633AbfLLTsi (ORCPT <rfc822;linux-bluetooth@vger.kernel.org>);
        Thu, 12 Dec 2019 14:48:38 -0500
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga008.fm.intel.com ([10.253.24.58])
  by fmsmga101.fm.intel.com with ESMTP/TLS/DHE-RSA-AES256-GCM-SHA384; 12 Dec 2019 11:48:37 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.69,306,1571727600"; 
   d="scan'208";a="211222632"
Received: from bgi1-mobl2.amr.corp.intel.com ([10.254.70.3])
  by fmsmga008.fm.intel.com with ESMTP; 12 Dec 2019 11:48:36 -0800
From:   Brian Gix <brian.gix@intel.com>
To:     linux-bluetooth@vger.kernel.org
Cc:     brian.gix@intel.com, inga.stotland@intel.com
Subject: [PATCH BlueZ] mesh: Refactor Secure Network Beaconing
Date:   Thu, 12 Dec 2019 11:48:28 -0800
Message-Id: <20191212194828.21540-1-brian.gix@intel.com>
...
index 5be7e0b58..f32444d92 100644
--- a/mesh/net-keys.c
+++ b/mesh/net-keys.c
@@ -23,16 +23,35 @@
...
@@ -305,18 +325,161 @@ bool net_key_snb_compose(uint32_t id, uint32_t iv_index, bool kr, bool ivu,
 		return false;
 	}
...
+						key->snb.observed,
+						key->snb.expected);
+		interval = (key->snb.observe_period * (key->snb.observed + 1))
+							/ key->snb.expected;
+		key->snb.observe_period = interval * 2;
+		key->snb.expected = key->snb.observe_period / 10;
+		key->snb.observed = 0;
+	} else
...
index f662d8a91..c483be40e 100644
--- a/mesh/net.c
+++ b/mesh/net.c
@@ -53,15 +53,9 @@
 #define SEG_TO	2
...
+	queue_friend_update(net);
 	net->iv_update_timeout = l_timeout_create(
 			IV_IDX_UPD_MIN,
 			iv_upd_to, net, NULL);
@@ -3043,34 +2924,6 @@ void mesh_net_sub_list_del(struct mesh_net *net, uint16_t addr)
 			0, 0, 0, msg, n);
 }
...
index fe4e0b653..07b87830d 100644
--- a/mesh/net.h
+++ b/mesh/net.h
