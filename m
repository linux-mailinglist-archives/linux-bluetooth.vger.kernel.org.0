...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CA0E854FFC7
	for <lists+linux-bluetooth@lfdr.de>; Sat, 18 Jun 2022 00:17:24 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1346517AbiFQWRW (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Fri, 17 Jun 2022 18:17:22 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59636 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230245AbiFQWRT (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Fri, 17 Jun 2022 18:17:19 -0400
Received: from mail-pj1-x1036.google.com (mail-pj1-x1036.google.com [IPv6:2607:f8b0:4864:20::1036])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 137D258E5F
        for <linux-bluetooth@vger.kernel.org>; Fri, 17 Jun 2022 15:17:17 -0700 (PDT)
Received: by mail-pj1-x1036.google.com with SMTP id cv13so2643348pjb.4
        for <linux-bluetooth@vger.kernel.org>; Fri, 17 Jun 2022 15:17:17 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=fPSWbb6EvN3DhPK6S2UX5mDEXY435HRvr7VG9w4j8SM=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=fPSWbb6EvN3DhPK6S2UX5mDEXY435HRvr7VG9w4j8SM=;
        b=
X-Gm-Message-State: AJIora/5lD9GE+U7kyh6kme9yJal5M1WFOwvJypTzRVb1PcQwv4bc8eS
        ME6+eyeqYjdQUq1RxgbJEeLcw7homok=
X-Google-Smtp-Source: AGRyM1vkRkDSehD91+thCUsQayimFaPlmJsqtz7I018qDsHUqVK9W/WO8mIHVV8wUiclGVacNfggNA==
X-Received: by 2002:a17:902:d2c7:b0:162:4f0a:c790 with SMTP id n7-20020a170902d2c700b001624f0ac790mr11239014plc.110.1655504235159;
        Fri, 17 Jun 2022 15:17:15 -0700 (PDT)
Received: from lvondent-mobl4.. (c-71-56-157-77.hsd1.or.comcast.net. [71.56.157.77])
        by smtp.gmail.com with ESMTPSA id jc21-20020a17090325d500b0016184e7b013sm4117261plb.36.2022.06.17.15.17.14
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Fri, 17 Jun 2022 15:17:14 -0700 (PDT)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH v3 2/7] Bluetooth: Add initial implementation of CIS connections
Date:   Fri, 17 Jun 2022 15:17:07 -0700
Message-Id: <20220617221712.1394014-2-luiz.dentz@gmail.com>
...
index 1ce89c469293..d540849428ef 100644
...
+	case ISO_LINK:
 		...
 		break;
@@ -1232,6 +1236,436 @@ struct hci_conn *hci_connect_sco(struct hci_dev *hdev, int type, bdaddr_t *dst,
 	return sco;
 }
...
index 2440275a143c..a2097760abec 100644
...
index e974a888c0f3..ea6d19ea7aef 100644
...
@@ -5427,3 +5463,14 @@ int hci_le_create_conn_sync(struct hci_dev *hdev, struct hci_conn *conn)
