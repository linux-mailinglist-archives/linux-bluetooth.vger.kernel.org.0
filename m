Return-Path: <linux-bluetooth+bounces-1618-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-bluetooth@lfdr.de
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [IPv6:2604:1380:4601:e00::3])
	by mail.lfdr.de (Postfix) with ESMTPS id 60E0984A7FE
	for <lists+linux-bluetooth@lfdr.de>; Mon,  5 Feb 2024 22:49:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id 776051F2B8AF
	for <lists+linux-bluetooth@lfdr.de>; Mon,  5 Feb 2024 21:49:08 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 14BFB134738;
	Mon,  5 Feb 2024 20:28:03 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="HVrGzzvs"
X-Original-To: linux-bluetooth@vger.kernel.org
Received: from mail-ua1-f54.google.com (mail-ua1-f54.google.com [209.85.222.54])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 5F9A113472E
	for <linux-bluetooth@vger.kernel.org>; Mon,  5 Feb 2024 20:27:59 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.222.54
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707164882; cv=none; b=oyFvXOsppTa2xsKG5EitMduSo7k4NjYMBgB8N4PM3GMRY3rVk0nwIX0L4iViplB7iUqA9xMFy+TIlmhvC/dYKaCMgSlhg/r6ofRjLTTrxEuDW0b+30FlWmTpnn3zm+QTJtwtoKkEtT8BNXY1iB8HxbXm1PBT1Z3pPqIDLNnTdPQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707164882; c=relaxed/simple;
	bh=iNDDt10RH5MEto2ELMZVlc4jycXT5Q6pNrm6c+6kfHo=;
	h=From:To:Subject:Date:Message-ID:MIME-Version; b=LCO5oldSA3gScSaTRlglpYLO8XRhis1NZHNCkboV3+oKvXq0mUt6eAJNGfFgVcLnYsISXir4t4DaLrzziDMktA4JjoxHFZjl1KkxQJwsWpXwFyrxoLDOre8+q1PjAxzjO96SDaIJftScYR2o3uKNmDyEuEfMUoEBJ6UPlvW31fQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=HVrGzzvs; arc=none smtp.client-ip=209.85.222.54
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-ua1-f54.google.com with SMTP id a1e0cc1a2514c-7ce3c7566e0so2061267241.1
        for <linux-bluetooth@vger.kernel.org>; Mon, 05 Feb 2024 12:27:59 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1707164877; x=1707769677; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:message-id:date:subject:to
         :from:from:to:cc:subject:date:message-id:reply-to;
        bh=HScwEe6zWV6cWf1OP1tSwk6dNFhe3j/s/geG/JUhtO8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1707164877; x=1707769677;
        h=content-transfer-encoding:mime-version:message-id:date:subject:to
         :from:x-gm-message-state:from:to:cc:subject:date:message-id:reply-to;
        bh=HScwEe6zWV6cWf1OP1tSwk6dNFhe3j/s/geG/JUhtO8=;
        b=
X-Gm-Message-State: AOJu0YzsVMRdDgbLReh7kdpsTbG6LVOFY1TJLHGZwfGbj3eVzINRNdp8
	2gNnwIyq6jzrvA8vU7l8N4J8fG2O6sNUwUCOXXyUNJ9ZRDwKJhtm6NYLm+qv
X-Google-Smtp-Source: AGHT+IFhv10cUy1jUhdDQvBjgRzhxgrX5U9zgXv1abXvREwI0hKuOjBhfTWfHxEJFXFS3lCIl9GXYg==
X-Received: by 2002:a05:6102:d87:b0:46d:2002:67f0 with SMTP id d7-20020a0561020d8700b0046d200267f0mr89576vst.13.1707164876738;
        Mon, 05 Feb 2024 12:27:56 -0800 (PST)
Received: from lvondent-mobl4.intel.com (071-047-239-151.res.spectrum.com. [71.47.239.151])
        by smtp.gmail.com with ESMTPSA id k14-20020ab0734e000000b007cbd3f0e920sm80123uap.15.2024.02.05.12.27.55
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 05 Feb 2024 12:27:55 -0800 (PST)
From: Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To: linux-bluetooth@vger.kernel.org
Subject: [PATCH BlueZ v1] shared/bap: Rework stream procedures
Date: Mon,  5 Feb 2024 15:27:54 -0500
Message-ID: <20240205202754.2295477-1-luiz.dentz@gmail.com>
...
---
 src/shared/bap.c | 1657 ++++++++++++++++++++++++++--------------------
 1 file changed, 940 insertions(+), 717 deletions(-)

diff --git a/src/shared/bap.c b/src/shared/bap.c
index 00d211c15ddf..a1a6846a0f96 100644
--- a/src/shared/bap.c
+++ b/src/shared/bap.c
@@ -214,6 +214,28 @@ struct bt_bap_stream_io {
 	bool connecting;
 };
 
+struct bt_bap_stream_ops {
+	uint8_t type;
+	int (*config)(struct bt_bap_stream *stream, struct bt_bap_qos *qos,
+			struct iovec *data, bt_bap_stream_func_t func,
+			void *user_data);
+	int (*qos)(struct bt_bap_stream *stream, struct bt_bap_qos *qos,
+			bt_bap_stream_func_t func, void *user_data);
+	int (*enable)(struct bt_bap_stream *stream, bool enable_links,
+			struct iovec *metadata, bt_bap_stream_func_t func,
+			void *user_data);
+	int (*start)(struct bt_bap_stream *stream, bt_bap_stream_func_t func,
+			void *user_data);
+	int (*disable)(struct bt_bap_stream *stream, bool disable_links,
+			bt_bap_stream_func_t func, void *user_data);
+	int (*stop)(struct bt_bap_stream *stream, bt_bap_stream_func_t func,
+			void *user_data);
+	int (*metadata)(struct bt_bap_stream *stream, struct iovec *data,
+			bt_bap_stream_func_t func, void *user_data);
+	int (*release)(struct bt_bap_stream *stream, bt_bap_stream_func_t func,
+			void *user_data);
+};
+
...
@@ -224,6 +246,7 @@ struct bt_bap_stream {
...
@@ -829,27 +852,46 @@ static bool bap_codec_equal(const struct bt_bap_codec *c1,
 	return c1->id == c2->id;
 }
...
@@ -985,6 +1027,14 @@ static void stream_notify_metadata(struct bt_bap_stream *stream)
 	free(status);
 }
...
@@ -1080,83 +1130,6 @@ static void bap_stream_update_io_links(struct bt_bap_stream *stream)
...
-
 ...
 {
 	struct bt_bap_stream *link;
@@ -1182,51 +1155,6 @@ static bool bap_stream_io_detach(struct bt_bap_stream *stream)
 	return true;
 }
...
@@ -1344,6 +1281,39 @@ static void bap_stream_state_changed(struct bt_bap_stream *stream)
 	bt_bap_unref(bap);
 }
...
+
 static void stream_set_state_broadcast(struct bt_bap_stream *stream,
 					uint8_t state)
 {
@@ -1390,73 +1360,831 @@ static void stream_set_state_broadcast(struct bt_bap_stream *stream,
 	bt_bap_unref(bap);
 }
...
+}
+
+static int bap_ucast_config(struct bt_bap_stream *stream,
...
+}
+
+static int bap_ucast_qos(struct bt_bap_stream *stream, struct bt_bap_qos *data,
+				bt_bap_stream_func_t func, void *user_data)
+{
+	struct iovec iov;
...
+}
+
+static int bap_bcast_config(struct bt_bap_stream *stream,
+				struct bt_bap_qos *qos, struct iovec *data,
+				bt_bap_stream_func_t func, void *user_data)
+{
+	stream->qos = *qos;
...
+}
+
+static int bap_ucast_enable(struct bt_bap_stream *stream, bool enable_links,
+				struct iovec *data, bt_bap_stream_func_t func,
+				void *user_data)
+{
+	int ret;
...
+}
+
+static int bap_ucast_start(struct bt_bap_stream *stream,
+				bt_bap_stream_func_t func, void *user_data)
+{
+	struct iovec iov;
...
+}
+
+static int bap_ucast_disable(struct bt_bap_stream *stream, bool disable_links,
+				bt_bap_stream_func_t func, void *user_data)
+{
+	struct iovec iov;
...
+}
+
+static int bap_ucast_stop(struct bt_bap_stream *stream,
+				bt_bap_stream_func_t func, void *user_data)
+{
+	struct iovec iov;
...
+}
+
+static int bap_ucast_metadata(struct bt_bap_stream *stream, struct iovec *data,
+				bt_bap_stream_func_t func, void *user_data)
+{
+	if (!stream->client) {
...
+}
+
+static int bap_ucast_release(struct bt_bap_stream *stream,
+				bt_bap_stream_func_t func, void *user_data)
+{
+	struct iovec iov;
...
+}
+
+static int bap_bcast_enable(struct bt_bap_stream *stream, bool enable_links,
+				struct iovec *data, bt_bap_stream_func_t func,
+				void *user_data)
+{
...
+}
+
+static int bap_bcast_start(struct bt_bap_stream *stream,
+				bt_bap_stream_func_t func, void *user_data)
+{
...
+}
+
+static int bap_bcast_disable(struct bt_bap_stream *stream, bool disable_links,
+				bt_bap_stream_func_t func, void *user_data)
+{
...
+}
+
+static int bap_bcast_metadata(struct bt_bap_stream *stream, struct iovec *data,
+				bt_bap_stream_func_t func, void *user_data)
+{
+	util_iov_free(stream->meta, 1);
...
+}
+
+static int bap_bcast_release(struct bt_bap_stream *stream,
+				bt_bap_stream_func_t func, void *user_data)
+{
...
@@ -1518,55 +2246,6 @@ static void ascs_ase_rsp_add_errno(struct iovec *iov, uint8_t id, int err)
 	}
 }
...
@@ -1826,17 +2505,6 @@ static uint8_t ascs_enable(struct bt_ascs *ascs, struct bt_bap *bap,
...
@@ -1970,20 +2638,6 @@ static uint8_t ascs_disable(struct bt_ascs *ascs, struct bt_bap *bap,
...
-
 ...
 {
 	struct bt_bap_stream *stream = ep->stream;
@@ -2045,19 +2699,6 @@ static uint8_t ascs_stop(struct bt_ascs *ascs, struct bt_bap *bap,
...
-
 static uint8_t ep_metadata(struct bt_bap_endpoint *ep, struct iovec *meta,
 						struct iovec *rsp)
 {
@@ -2110,23 +2751,6 @@ static uint8_t ascs_metadata(struct bt_ascs *ascs, struct bt_bap *bap,
...
-
 static uint8_t ascs_release(struct bt_ascs *ascs, struct bt_bap *bap,
 				struct iovec *iov, struct iovec *rsp)
 {
@@ -2363,20 +2987,6 @@ static struct bt_pacs *bap_get_pacs(struct bt_bap *bap)
 	return bap->rdb->pacs;
 }
...
@@ -3844,156 +4454,6 @@ static void bap_endpoint_attach(struct bt_bap *bap, struct bt_bap_endpoint *ep)
...
-
 static void bap_cp_notify(struct bt_bap *bap, uint16_t value_handle,
 				...
 				void *user_data)
@@ -4562,35 +5022,6 @@ static bool find_ep_pacs(const void *data, const void *user_data)
 	return false;
 }
...
-
 unsigned int bt_bap_stream_config(struct bt_bap_stream *stream,
 					struct bt_bap_qos *qos,
 					struct iovec *data,
@@ -4876,10 +5307,7 @@ unsigned int bt_bap_stream_qos(struct bt_bap_stream *stream,
 	struct bt_ascs_qos qos;
 	struct bt_bap_req *req;
...
+	if (!bap_stream_valid(stream))
 	...
 	memset(&qos, 0, sizeof(qos));
@@ -4911,130 +5339,33 @@ unsigned int bt_bap_stream_qos(struct bt_bap_stream *stream,
 	return req->id;
 }
...
-
-	return ret;
+	return stream->ops->enable(stream, enable_links, metadata, func,
+					user_data);
 }
...
-
-	return 0;
+	return stream->ops->start(stream, func, user_data);
 }
 
 unsigned int bt_bap_stream_disable(struct bt_bap_stream *stream,
@@ -5042,84 +5373,26 @@ unsigned int bt_bap_stream_disable(struct bt_bap_stream *stream,
 					bt_bap_stream_func_t func,
 					void *user_data)
 {
-	struct iovec iov;
...
-
-	return 0;
+	return stream->ops->disable(stream, disable_links, func, user_data);
 }
...
-
-	return req->id;
+	return stream->ops->stop(stream, func, user_data);
 }
 
 unsigned int bt_bap_stream_metadata(struct bt_bap_stream *stream,
@@ -5127,73 +5400,23 @@ unsigned int bt_bap_stream_metadata(struct bt_bap_stream *stream,
 					bt_bap_stream_func_t func,
 					void *user_data)
 {
-	if (!stream)
...
-	}
+
+	return stream->ops->metadata(stream, metadata, func, user_data);
 }
...
-
-	return req->id;
+	return stream->ops->release(stream, func, user_data);
 }
