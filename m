...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id F057B13209A
	for <lists+linux-bluetooth@lfdr.de>; Tue,  7 Jan 2020 08:41:09 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727559AbgAGHlD (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Tue, 7 Jan 2020 02:41:03 -0500
Received: from mail-pf1-f175.google.com ([209.85.210.175]:33404 "EHLO
        mail-pf1-f175.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727539AbgAGHlD (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Tue, 7 Jan 2020 02:41:03 -0500
Received: by mail-pf1-f175.google.com with SMTP id z16so28191576pfk.0
        for <linux-bluetooth@vger.kernel.org>; Mon, 06 Jan 2020 23:41:02 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=exMvBxwwNi2XCVVpb51OAGA+MdbqIGINOSvKfD0DnNo=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=exMvBxwwNi2XCVVpb51OAGA+MdbqIGINOSvKfD0DnNo=;
        b=
X-Gm-Message-State: APjAAAU/P+ARYfo47IIj9xgX3RYltXmEiPmZ/q0wYKGOIaDrFvU5iJ84
        YXa4H7TR0xWAZyPXS/AYwW4oEbPrqng=
X-Google-Smtp-Source: APXvYqxHZ1IBGL5yylA143n4j6oX5+5BwUQd6kKVkp/T2YxdUEIlvDcAqN41nTQsVYxj4v9lFYv7Mw==
X-Received: by 2002:a62:5214:: with SMTP id g20mr110464886pfb.101.1578382860241;
        Mon, 06 Jan 2020 23:41:00 -0800 (PST)
Received: from vudentzs-t460s.hsd1.or.comcast.net ([2601:1c0:6800:1640::3287])
        by smtp.gmail.com with ESMTPSA id k21sm67725388pfa.63.2020.01.06.23.40.58
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 06 Jan 2020 23:40:59 -0800 (PST)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH 02/10] Bluetooth: Add initial implementation of CIS connections
Date:   Mon,  6 Jan 2020 23:40:48 -0800
Message-Id: <20200107074056.25453-3-luiz.dentz@gmail.com>
...
+
 ...
 __printf(1, 2)
@@ -410,6 +431,9 @@ static inline void sco_exit(void)
 }
 #endif
...
index faebe3859931..3fc4fcd1eb53 100644
...
@@ -609,6 +614,9 @@ static inline void sco_recv_scodata(struct hci_conn *hcon, struct sk_buff *skb)
 }
 #endif
...
@@ -729,6 +737,9 @@ static inline void hci_conn_hash_add(struct hci_dev *hdev, struct hci_conn *c)
 	case ESCO_LINK:
 		h->sco_num++;
 		break;
+	case ISO_LINK:
...
@@ -755,6 +766,9 @@ static inline void hci_conn_hash_del(struct hci_dev *hdev, struct hci_conn *c)
 	case ESCO_LINK:
 		h->sco_num--;
 		break;
+	case ISO_LINK:
...
@@ -771,6 +785,8 @@ static inline unsigned int hci_conn_num(struct hci_dev *hdev, __u8 type)
 	case SCO_LINK:
 	case ESCO_LINK:
 		return h->sco_num;
+	case ISO_LINK:
...
@@ -780,7 +796,7 @@ static inline unsigned int hci_conn_count(struct hci_dev *hdev)
 {
...
@@ -866,6 +882,30 @@ static inline struct hci_conn *hci_conn_hash_lookup_le(struct hci_dev *hdev,
 	return NULL;
 }
...
+
 ...
 {
@@ -909,6 +949,7 @@ static inline struct hci_conn *hci_lookup_le_connect(struct hci_dev *hdev)
...
+bool hci_le_create_cis(struct hci_conn *conn);
 ...
 struct hci_conn *hci_conn_add(struct hci_dev *hdev, int type, bdaddr_t *dst,
 			      u8 role);
@@ -931,6 +972,10 @@ struct hci_conn *hci_connect_acl(struct hci_dev *hdev, bdaddr_t *dst,
...
@@ -1217,6 +1262,11 @@ void hci_conn_del_sysfs(struct hci_conn *conn);
...
@@ -1231,6 +1281,9 @@ static inline int hci_proto_connect_ind(struct hci_dev *hdev, bdaddr_t *bdaddr,
 	case ESCO_LINK:
...
+
 	default:
 		...
 		return -EINVAL;
@@ -1461,6 +1514,7 @@ int hci_send_cmd(struct hci_dev *hdev, __u16 opcode, __u32 plen,
 		 const void *param);
