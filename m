...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id EEFEB23E572
	for <lists+linux-bluetooth@lfdr.de>; Fri,  7 Aug 2020 03:17:20 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726058AbgHGBRU (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Thu, 6 Aug 2020 21:17:20 -0400
Received: from mga03.intel.com ([134.134.136.65]:31449 "EHLO mga03.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726011AbgHGBRU (ORCPT <rfc822;linux-bluetooth@vger.kernel.org>);
        Thu, 6 Aug 2020 21:17:20 -0400
IronPort-SDR: qcCDsTMPKrpFVwnxa77ZmAtlJcVCHgaZVFTubQHObFUO6X77JeVrQh0hXGTaLSpfdxI6nKa3YL
 GvEwvc2PLGSQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9705"; a="152936390"
X-IronPort-AV: E=Sophos;i="5.75,443,1589266800"; 
   d="scan'208";a="152936390"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga005.fm.intel.com ([10.253.24.32])
  by orsmga103.jf.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 06 Aug 2020 18:17:17 -0700
IronPort-SDR: gG8ehUGZkalLnfNTlR3ARitinWpGV0WwfhHmSeay2TLQH6thbHMQM9F9jDdoD+9hfcwdzmHM2B
 z/iT/qLwogmA==
X-IronPort-AV: E=Sophos;i="5.75,443,1589266800"; 
...
Subject: [PATCH 2/3] tools/btpclientctl: Add btpclient test application
Date:   Thu,  6 Aug 2020 18:17:02 -0700
Message-Id: <20200807011703.22087-2-tedd.an@linux.intel.com>
...
---
 Makefile.tools        |    7 +-
 tools/btpclientctrl.c | 2151 +++++++++++++++++++++++++++++++++++++++++
 2 files changed, 2157 insertions(+), 1 deletion(-)
 create mode 100644 tools/btpclientctrl.c

diff --git a/Makefile.tools b/Makefile.tools
index 9b9236609..6100c2bdf 100644
--- a/Makefile.tools
+++ b/Makefile.tools
...
+noinst_PROGRAMS += tools/btpclient tools/btpclientctrl
...
+
+tools_btpclientctrl_SOURCES = tools/btpclientctrl.c client/display.c
+tools_btpclientctrl_LDADD = lib/libbluetooth-internal.la \
+				src/libshared-mainloop.la $(GLIB_LIBS) \
+				src/libshared-glib.la -lreadline
 endif
diff --git a/tools/btpclientctrl.c b/tools/btpclientctrl.c
