...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 036BC14A386
	for <lists+linux-bluetooth@lfdr.de>; Mon, 27 Jan 2020 13:10:47 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730472AbgA0MKq convert rfc822-to-8bit (ORCPT
        <rfc822;lists+linux-bluetooth@lfdr.de>);
        Mon, 27 Jan 2020 07:10:46 -0500
Received: from coyote.holtmann.net ([212.227.132.17]:57754 "EHLO
        mail.holtmann.org" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1730448AbgA0MKp (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Mon, 27 Jan 2020 07:10:45 -0500
Received: from marcel-macbook.fritz.box (p4FEFC5A7.dip0.t-ipconnect.de [79.239.197.167])
        by mail.holtmann.org (Postfix) with ESMTPSA id B8AE6CECD2;
        Mon, 27 Jan 2020 13:20:03 +0100 (CET)
...
In-Reply-To: <CABBYNZLO4eMR5CxbbnUNi5ne-BWPnSHm+GNsAZWCvp4GS-s2Hg@mail.gmail.com>
Date:   Mon, 27 Jan 2020 13:10:43 +0100
Cc:     "linux-bluetooth@vger.kernel.org" <linux-bluetooth@vger.kernel.org>
Content-Transfer-Encoding: 8BIT
Message-Id: <7C43E4FA-57C7-4CC4-B113-3D19EC3BEBB2@holtmann.org>
...
With the above, there would be no wait. For the incoming connections case it is no different then it is right now. The connection is ready and the accept() call just distributes the fd. Setting BT_DEFER_SETUP is the tricky one with a listening socket. But in the end, if you read() from one of the sockets all fd become active, same as you close() one, all will be closed. So you just decide once to accept or reject the connection. And since accept() call are all sequential, we could just delay signaling the other accept() until we got the read() / close() call.
