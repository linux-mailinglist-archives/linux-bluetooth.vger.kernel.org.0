...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9EA862AFCF0
	for <lists+linux-bluetooth@lfdr.de>; Thu, 12 Nov 2020 02:49:35 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728530AbgKLBdC (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Wed, 11 Nov 2020 20:33:02 -0500
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57540 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727714AbgKKXE2 (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Wed, 11 Nov 2020 18:04:28 -0500
Received: from mail-pl1-x632.google.com (mail-pl1-x632.google.com [IPv6:2607:f8b0:4864:20::632])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 50D9BC0613D6
        for <linux-bluetooth@vger.kernel.org>; Wed, 11 Nov 2020 15:04:28 -0800 (PST)
Received: by mail-pl1-x632.google.com with SMTP id g11so1744091pll.13
        for <linux-bluetooth@vger.kernel.org>; Wed, 11 Nov 2020 15:04:28 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=3yEDrCb1EBm4kbqOZCm/GZx8XbFSYSJgbEEeacRC6V4=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=3yEDrCb1EBm4kbqOZCm/GZx8XbFSYSJgbEEeacRC6V4=;
        b=
X-Gm-Message-State: AOAM533PB1gMUfAXhwe7mmIzjv95OfZJJxJL2giBBewjBHTXc5sfXBuM
        DIntZ7GESSG+fOKyqlXw3jxqLPb7jcPoHw==
X-Google-Smtp-Source: ABdhPJz3nVtp+wy5jMkGxT1Ewm2w70Mgv8jA3J+ANv+oe7ICBbjl8JM0Rpz5dJY5N2Iu4xtvggVsKA==
X-Received: by 2002:a17:902:ed52:b029:d7:d0af:f89f with SMTP id y18-20020a170902ed52b02900d7d0aff89fmr20052689plb.26.1605135866054;
        Wed, 11 Nov 2020 15:04:26 -0800 (PST)
Received: from localhost.localdomain (c-71-56-157-77.hsd1.or.comcast.net. [71.56.157.77])
        by smtp.gmail.com with ESMTPSA id n27sm3867767pfq.59.2020.11.11.15.04.24
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Wed, 11 Nov 2020 15:04:25 -0800 (PST)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH v2 01/10] btdev: Rework command handling
Date:   Wed, 11 Nov 2020 15:04:12 -0800
Message-Id: <20201111230421.3364932-2-luiz.dentz@gmail.com>
...
---
 ...
 1 file changed, 3834 insertions(+), 3151 deletions(-)

diff --git a/emulator/btdev.c b/emulator/btdev.c
index a36493346..05604a9c9 100644
--- a/emulator/btdev.c
+++ b/emulator/btdev.c
@@ -20,6 +20,7 @@
 #include <alloca.h>
...
@@ -334,889 +2116,863 @@ static void set_common_commands_bredr20(struct btdev *btdev)
...
@@ -1545,545 +3128,436 @@ static void le_conn_param_req(struct btdev *btdev, uint16_t handle,
 	send_event(remote, BT_HCI_EVT_LE_META_EVENT, &ev, sizeof(ev));
 }
...
@@ -2123,88 +3597,6 @@ static void send_ext_adv(struct btdev *btdev, const struct btdev *remote,
...
@@ -2222,8 +3614,7 @@ static void le_set_ext_adv_enable_complete(struct btdev *btdev)
...
+		send_ext_adv(btdev_list[i], btdev, report_type, false);
 		...
 		if (btdev_list[i]->le_scan_type != 0x01)
 			continue;
@@ -2239,61 +3630,181 @@ static void le_set_ext_adv_enable_complete(struct btdev *btdev)
 			else
 				continue;
...
@@ -2307,1937 +3818,1098 @@ static void le_set_ext_scan_enable_complete(struct btdev *btdev)
 			else
 				continue;
...
@@ -4259,20 +4931,26 @@ static void handler_callback(btdev_callback callback, uint8_t response,
...
@@ -4291,6 +4969,7 @@ static void process_cmd(struct btdev *btdev, const void *data, uint16_t len)
 {
...
+	const struct btdev_cmd *cmd;
 	...
 	if (len < sizeof(*hdr))
 		return;
@@ -4312,14 +4991,18 @@ static void process_cmd(struct btdev *btdev, const void *data, uint16_t len)
 		if (!run_hooks(btdev, BTDEV_HOOK_PRE_CMD, callback.opcode,
 						callback.data, callback.len))
 			return;
-		default_cmd(btdev, callback.opcode,
