...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C9EDB25639D
	for <lists+linux-bluetooth@lfdr.de>; Sat, 29 Aug 2020 02:08:13 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726821AbgH2AIN (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Fri, 28 Aug 2020 20:08:13 -0400
Received: from mga12.intel.com ([192.55.52.136]:10238 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726775AbgH2AIL (ORCPT <rfc822;linux-bluetooth@vger.kernel.org>);
        Fri, 28 Aug 2020 20:08:11 -0400
IronPort-SDR: jdn1x6s5jF4+jw77bjI5I2re3673hHc6CXqfsRfgwU5fyKA9Kcnb/pl7UfkrfgKtE2ydscQYN2
 5rkzcKIZvcwQ==
X-IronPort-AV: E=McAfee;i="6000,8403,9727"; a="136305339"
X-IronPort-AV: E=Sophos;i="5.76,365,1592895600"; 
   d="scan'208";a="136305339"
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga004.fm.intel.com ([10.253.24.48])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 28 Aug 2020 17:08:10 -0700
IronPort-SDR: zxtIEoEcenhuLToqGgHugmlc0TYS4RG/hMy2C/zPhd2zvoR6QYgDmENfoz0xW4VkRAkOwsrETV
 jpejN8mwz0MQ==
X-IronPort-AV: E=Sophos;i="5.76,365,1592895600"; 
   d="scan'208";a="324213877"
...
Subject: [V3 2/3] tools/btpclientctl: Add btpclient test application
Date:   Fri, 28 Aug 2020 17:08:02 -0700
Message-Id: <20200829000803.20286-2-tedd.an@intel.com>
...
---
 .gitignore           |    1 +
 Makefile.tools       |    6 +-
 tools/btpclientctl.c | 2372 ++++++++++++++++++++++++++++++++++++++++++
 3 files changed, 2378 insertions(+), 1 deletion(-)
