Return-Path: <linux-bluetooth+bounces-891-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-bluetooth@lfdr.de
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from am.mirrors.kernel.org (am.mirrors.kernel.org [147.75.80.249])
	by mail.lfdr.de (Postfix) with ESMTPS id 96FA7824752
	for <lists+linux-bluetooth@lfdr.de>; Thu,  4 Jan 2024 18:23:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by am.mirrors.kernel.org (Postfix) with ESMTPS id EC09E1F257D5
	for <lists+linux-bluetooth@lfdr.de>; Thu,  4 Jan 2024 17:23:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A9A8228DBA;
	Thu,  4 Jan 2024 17:17:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=nxp.com header.i=@nxp.com header.b="czRti8Ht"
...
Received: from EUR05-AM6-obe.outbound.protection.outlook.com (mail-am6eur05on2055.outbound.protection.outlook.com [40.107.22.55])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 02374286AD
	for <linux-bluetooth@vger.kernel.org>; Thu,  4 Jan 2024 17:17:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=nxp.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=nxp.com
ARC-Seal: i=1; a=rsa-sha256; s=arcselector9901; d=microsoft.com; cv=none;
 b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=microsoft.com;
 s=arcselector9901;
 h=From:Date:Subject:Message-ID:Content-Type:MIME-Version:X-MS-Exchange-AntiSpam-MessageData-ChunkCount:X-MS-Exchange-AntiSpam-MessageData-0:X-MS-Exchange-AntiSpam-MessageData-1;
 bh=aoIwSehN1qE4NUNo91wesTfEHc54fvZasPLqZx9MZP4=;
 b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=nxp.com; s=selector2;
 ...
 bh=aoIwSehN1qE4NUNo91wesTfEHc54fvZasPLqZx9MZP4=;
 b=czRti8HtAdUs4KkXdqurt2gBQhpcz3cPWWMI9+An1zcNctjdZdTVNxrwMAPFxSxxKZ0LOwyh1RS+znadHDD3ze9m4AAlSKeViwPbQ1p6PIxNdmaKnErq+TGC52sJb5tMmd8oW0P8vIxBBygR4eq9dcGCKNt3FCOswDyNEp1lCjg=
...
Subject: [PATCH 2/2] bap.c: Add support for multiple BISes
Date: Thu,  4 Jan 2024 19:16:52 +0200
Message-Id: <20240104171652.189629-3-silviu.barbulescu@nxp.com>
...
X-ClientProxiedBy: AS4P189CA0058.EURP189.PROD.OUTLOOK.COM
 (2603:10a6:20b:659::20) To VI1PR04MB10073.eurprd04.prod.outlook.com
 (2603:10a6:800:1dd::8)
Precedence: bulk
...
X-MS-Office365-Filtering-Correlation-Id: 5a69ddd1-2c4e-4487-2579-08dc0d48f92d
X-MS-Exchange-SenderADCheck: 1
X-MS-Exchange-AntiSpam-Relay: 0
X-Microsoft-Antispam: BCL:0;
X-Microsoft-Antispam-Message-Info:
	
...
X-MS-Exchange-AntiSpam-MessageData-0:
	=?us-ascii?Q?6wwJGDxNK0lTwDcxV6KwiSY+7p9ozXnBoJxKGwlzPQYcx03hDLAcQ0AxFkvN?=
 =?us-ascii?Q?dIDdl9VH9x1wh7bZIbYdG+a23TbzU524o0aamHOCrz06kvWnMbQKfarR5QHE?=
 =?us-ascii?Q?ZHgKoa24oCvmhmaDb7BbNBaTdbG63yQFBpyhJBGF+60sYmJE0TDF26ovKSU4?=
 =?us-ascii?Q?tmivxlaTMuRtGJtSYXXlRsJWHkw3Qn8EOd4AcT4E6dyWmn+z0B/aGy3/tlX9?=
 =?us-ascii?Q?j6Ic/cEFIKVIM/7rdJCM1DthpFvD2iNkTSvMBPj1TzJtBwqTWUneznjGQfmo?=
 =?us-ascii?Q?0JwdUeJ0rZ+dq9YXFrnP3YVyPbu0Qgl4CBDgjZm3HbRahnObB65JwGlzsbK7?=
 =?us-ascii?Q?CaBLlMkGd0ZLaFGzvc/ej8gmiI1dnC9rB2IhaiaPuoM1YT9cnZ9FcjhLz9va?=
 =?us-ascii?Q?2CJsLYfGpmVFwIIFUTugsaXl1OUlRPYoqUnpXd/YtbnTOwTt2nMAc6fMBRCm?=
 =?us-ascii?Q?j87i/cur+LhqIqhQEX4Cl2i1JWn3ydBs0HDeev9hHnCK02Bz1oyzONr7ngwP?=
 =?us-ascii?Q?R2fZ2R1kt2Orl0AcThbrNDex1w0aAZ5UZLRXIgChOys6oo6ojb2Xl0BT3Pxj?=
 =?us-ascii?Q?R6r9/11PWCfaZyKi8A3X6bgVH3m2Pz4dZsPlsB3rlRZEjgIMtf23v3H8yWsS?=
 =?us-ascii?Q?d3sGdTLOMJJ/JWzLsiOnZCvt98xsqT8XlTMnFMy8wI5++0C7uRzXw7ec4K9m?=
 =?us-ascii?Q?42QdT57eexlg51Ku4udVOnN09Lob4eWAyWA3NdeV658Hgk+f3y5CZz0HV26r?=
 =?us-ascii?Q?mBLk8lS7W+drzlg6vrYzKzq85IZUU5crHzH81YucXHY2BmW54dqZz3ys1NnO?=
 =?us-ascii?Q?V3VT8XwBaiqTzd8050lhg0bURN+i2vLfxFtyV0/Wp0ZFDkfbR4CdX2g6eo+t?=
 =?us-ascii?Q?YwaG/uFzKdXQt8KBhw3XnlN1aBqZtQ1F+ybpcj69rZA+kW3EP0G/kUR3gZHL?=
 =?us-ascii?Q?qctikkQAX9d+iNl3Dw9thQap+pCsDGDVklQW22jwV0HckybkoEQI0HTCNhHo?=
 =?us-ascii?Q?rhGb+0FZ4rVHCd36SPzIGQtOPVYzZjXLvZUxoRbsQ8x/l+m9xjl4YjH9CqIb?=
 =?us-ascii?Q?SILaIiLuGJkO2iAHnq5lqAnMoyiyVlu99RTIUReHVJMpSIb3jm68MiQoqYJF?=
 =?us-ascii?Q?bP2euA9/JRSoUsalJ8EPEsniWKEy+v9sg8TylUWwD0xpV7WwaQm83M5logxF?=
 =?us-ascii?Q?iNCGP3nfWIXoybz6hgcgmPj/6Ij12LyqL3q2tCoxD46pWgGQuvVJCHuMIm3b?=
 =?us-ascii?Q?FKCqHZgc7sgSmTty9WGzor3tQo9NLAgS2EzAP9KugyFJR6twI70CKEPWfJBo?=
 =?us-ascii?Q?lsxrJPxn0ral0t0kHDaiUui5VQu4Bd2ZRa5ZShyUGa63Mq0fT8piUhvsSWsz?=
 =?us-ascii?Q?fafimT3tEf1wkBxz7poTzJ+XT2dq63wcnex6RBMM9HFCQv5YteeDrRnXoM1x?=
 =?us-ascii?Q?OBuiDZ10wtpPKstFHJHfBbK76bMxSU4mZhX6aPaU7NMfk8hUe920hMKra5kQ?=
 =?us-ascii?Q?ls3dincoFf4xP1gQmVz0ry5olwsGJK/DwjQZ3JPSEhmQFS2KIUaald4O3KE1?=
 =?us-ascii?Q?nSRt4ZQYg5nV7jx4y7deE1/jOla0IqnXtlammNMFPavnBI9Q5dLX6yZXfjab?=
 =?us-ascii?Q?iw=3D=3D?=
X-OriginatorOrg: nxp.com
X-MS-Exchange-CrossTenant-Network-Message-Id: 5a69ddd1-2c4e-4487-2579-08dc0d48f92d
X-MS-Exchange-CrossTenant-AuthSource: VI1PR04MB10073.eurprd04.prod.outlook.com
X-MS-Exchange-CrossTenant-AuthAs: Internal
X-MS-Exchange-CrossTenant-OriginalArrivalTime: 04 Jan 2024 17:17:05.1368
 (UTC)
X-MS-Exchange-CrossTenant-FromEntityHeader: Hosted
X-MS-Exchange-CrossTenant-Id: 686ea1d3-bc2b-4c6f-a92c-d99c5c301635
X-MS-Exchange-CrossTenant-MailboxType: HOSTED
X-MS-Exchange-CrossTenant-UserPrincipalName: ORUIXr668r98r/scTWmSnoJ4Z/3WRYWirANX1tF4/nIpRN6W/EyKwd3++EgzzXFlYZdq+X41n79mLlFrN58f7oBD5QkVauujSqp0hh9ctTE=
...
---
 ...
 src/shared/bap.h           |   36 +-
 4 files changed, 1550 insertions(+), 235 deletions(-)
...
index e2073451c..5a331d703 100644
...
+				strcasecmp(uuid, BAA_SERVICE_UUID))
 		...
 		bap = transport->data;
@@ -647,6 +649,7 @@ static DBusMessage *release(DBusConnection *conn, DBusMessage *msg,
 	const char *sender;
...
@@ -675,9 +678,12 @@ static DBusMessage *release(DBusConnection *conn, DBusMessage *msg,
...
+			bap_disable_complete(bap->stream, 0x00, 0x00, owner);
 	...
 	return NULL;
@@ -692,7 +698,11 @@ static gboolean get_device(const GDBusPropertyTable *property,
 	if (transport->device)
...
@@ -1034,6 +1044,7 @@ static gboolean get_bcast_qos(const GDBusPropertyTable *property,
...
@@ -1052,10 +1063,9 @@ static gboolean get_bcast_qos(const GDBusPropertyTable *property,
...
@@ -1502,9 +1512,10 @@ static void bap_state_changed(struct bt_bap_stream *stream, uint8_t old_state,
...
@@ -1521,7 +1532,7 @@ static void bap_state_changed(struct bt_bap_stream *stream, uint8_t old_state,
 			bap_update_bcast_qos(transport);
 		break;
