...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C95E2343BE2
	for <lists+linux-bluetooth@lfdr.de>; Mon, 22 Mar 2021 09:37:28 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229893AbhCVIg4 (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Mon, 22 Mar 2021 04:36:56 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:57424 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229872AbhCVIgX (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Mon, 22 Mar 2021 04:36:23 -0400
Received: from mail-qv1-xf49.google.com (mail-qv1-xf49.google.com [IPv6:2607:f8b0:4864:20::f49])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id E1844C061574
        for <linux-bluetooth@vger.kernel.org>; Mon, 22 Mar 2021 01:36:22 -0700 (PDT)
Received: by mail-qv1-xf49.google.com with SMTP id bt20so27717782qvb.0
        for <linux-bluetooth@vger.kernel.org>; Mon, 22 Mar 2021 01:36:22 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc;
        bh=P5+s5a7HGhcxJDqVPPe1AH8mdMB9DUfd/H29CMr6UXs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=P5+s5a7HGhcxJDqVPPe1AH8mdMB9DUfd/H29CMr6UXs=;
        b=
X-Gm-Message-State: AOAM530p8JwUxEx1iZJpbbWQCmGbbeCwJo8u2t9JDxr9zhPkIh+1pKs2
        HE3tFkKC+tmOjp/6lsd7f3FZ2nDNlSXEa1Bt6ziyLDsJFUyPpTOjIdQR+PZ6FS1NONXRTlaF7tF
        4oFGW+h7XF8u5d1YEdesAQx58DxbeeiKFwPxB3/QWRe1+CWfbIm1XrNktlcwgHbJFsWTxPbxs/6
        NQ
X-Google-Smtp-Source: ABdhPJw1/6bfnrTkyrnaRQfqfuUBqAzdvMTUrzMIwS3aY3hp1VOrhWQk+4gjQsj/8czXDi0wj/1kOe7GmCr/
X-Received: from apusaka-p920.tpe.corp.google.com ([2401:fa00:1:b:fdf3:9f7d:e4e3:ccad])
 (user=apusaka job=sendgmr) by 2002:a0c:f805:: with SMTP id
 r5mr19837725qvn.45.1616402182041; Mon, 22 Mar 2021 01:36:22 -0700 (PDT)
Date:   Mon, 22 Mar 2021 16:36:13 +0800
In-Reply-To: <20210322163554.Bluez.v4.1.I8797a75fcc7c1e997f177b08dc23a1df0272e0a5@changeid>
Message-Id: <20210322163554.Bluez.v4.2.I2aa61d391caefc5b67213911b5ef02b2ce191633@changeid>
Mime-Version: 1.0
References: <20210322163554.Bluez.v4.1.I8797a75fcc7c1e997f177b08dc23a1df0272e0a5@changeid>
X-Mailer: git-send-email 2.31.0.rc2.261.g7f71774620-goog
Subject: [Bluez PATCH v4 2/2] adv_monitor: merge monitors with the same pattern
...
* Remove unnecessary variable
 ...
 src/adv_monitor.c | 647 +++++++++++++++++++++++++++++++++++++---------
 1 file changed, 520 insertions(+), 127 deletions(-)

diff --git a/src/adv_monitor.c b/src/adv_monitor.c
index 131dc80039..d535aef790 100644
--- a/src/adv_monitor.c
+++ b/src/adv_monitor.c
...
+
 const struct adv_monitor_type {
 	...
 	const char *name;
@@ -199,6 +228,261 @@ static void pattern_free(void *data)
 	free(pattern);
 }
...
+
 ...
 {
@@ -208,8 +492,6 @@ static void monitor_free(struct adv_monitor *monitor)
...
@@ -218,10 +500,12 @@ static void monitor_release(struct adv_monitor *monitor)
 {
...
+	    monitor->state != MONITOR_STATE_INITED &&
 		...
 		return;
@@ -234,53 +518,56 @@ static void monitor_release(struct adv_monitor *monitor)
 					NULL);
 }
...
@@ -334,7 +621,8 @@ static void monitor_state_released(void *data, void *user_data)
 {
...
+				&& monitor->state != MONITOR_STATE_ACTIVE)
 	...
 	monitor->state = MONITOR_STATE_RELEASED;
@@ -394,9 +682,6 @@ static struct adv_monitor *monitor_new(struct adv_monitor_app *app,
...
@@ -439,7 +724,7 @@ static bool parse_monitor_type(struct adv_monitor *monitor, const char *path)
...
+
 ...
 failed:
@@ -586,14 +873,14 @@ static bool parse_patterns(struct adv_monitor *monitor, const char *path)
 		return false;
 	}
...
@@ -637,21 +924,18 @@ static bool parse_patterns(struct adv_monitor *monitor, const char *path)
 		if (!pattern)
 			goto failed;
...
@@ -686,64 +1043,81 @@ static void add_adv_patterns_monitor_cb(uint8_t status, uint16_t length,
 					const void *param, void *user_data)
 {
...
@@ -753,38 +1127,40 @@ static bool monitor_send_add_pattern(struct adv_monitor *monitor)
 }
...
@@ -793,14 +1169,26 @@ static bool monitor_send_add_pattern_rssi(struct adv_monitor *monitor)
 	return success;
 }
...
@@ -822,7 +1210,7 @@ static void monitor_proxy_added_cb(GDBusProxy *proxy, void *user_data)
 		return;
 	}
...
+	if (!monitor_process(monitor)) {
 		...
 		DBG("Adv Monitor at path %s released due to invalid content",
 			path);
@@ -831,10 +1219,24 @@ static void monitor_proxy_added_cb(GDBusProxy *proxy, void *user_data)
...
@@ -1064,54 +1466,38 @@ static const GDBusPropertyTable adv_monitor_properties[] = {
 	{ }
 };
...
@@ -1129,8 +1515,8 @@ static void adv_monitor_removed_callback(uint16_t index, uint16_t length,
 		return;
 	}
...
+	queue_foreach(manager->merged_patterns, remove_merged_pattern, &handle);
 	...
 	DBG("Adv Monitor removed event with handle 0x%04x processed",
 		ev->monitor_handle);
@@ -1154,6 +1540,7 @@ static struct btd_adv_monitor_manager *manager_new(
...
@@ -1168,6 +1555,7 @@ static void manager_free(struct btd_adv_monitor_manager *manager)
...
@@ -1274,6 +1662,7 @@ static void adv_match_per_monitor(void *data, void *user_data)
 {
 	struct adv_monitor *monitor = data;
...
@@ -1283,8 +1672,12 @@ static void adv_match_per_monitor(void *data, void *user_data)
 	if (monitor->state != MONITOR_STATE_ACTIVE)
 		return;
