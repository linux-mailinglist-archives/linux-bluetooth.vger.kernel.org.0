...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 141CC55CD5A
	for <lists+linux-bluetooth@lfdr.de>; Tue, 28 Jun 2022 15:02:49 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243283AbiF1Eab convert rfc822-to-8bit (ORCPT
        <rfc822;lists+linux-bluetooth@lfdr.de>);
        Tue, 28 Jun 2022 00:30:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:52426 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S242937AbiF1Eaa (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Tue, 28 Jun 2022 00:30:30 -0400
Received: from mail.pgj.campeche.gob.mx (unknown [187.157.28.107])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 12B3F1BEB5;
        Mon, 27 Jun 2022 21:30:29 -0700 (PDT)
Received: from localhost (localhost [127.0.0.1])
        by mail.pgj.campeche.gob.mx (Postfix) with ESMTP id 200A31BC8530;
        Mon, 27 Jun 2022 23:17:47 -0500 (CDT)
Received: from mail.pgj.campeche.gob.mx ([127.0.0.1])
        by localhost (mail.pgj.campeche.gob.mx [127.0.0.1]) (amavisd-new, port 10032)
        with ESMTP id Vv12S3I2ZUo7; Mon, 27 Jun 2022 23:17:45 -0500 (CDT)
Received: from localhost (localhost [127.0.0.1])
        by mail.pgj.campeche.gob.mx (Postfix) with ESMTP id 600D91BC850E;
        Mon, 27 Jun 2022 23:17:44 -0500 (CDT)
X-Virus-Scanned: amavisd-new at pgj.campeche.gob.mx
Received: from mail.pgj.campeche.gob.mx ([127.0.0.1])
        by localhost (mail.pgj.campeche.gob.mx [127.0.0.1]) (amavisd-new, port 10026)
        with ESMTP id ugJ_8Ny9p0Ac; Mon, 27 Jun 2022 23:17:43 -0500 (CDT)
Received: from mail.pgj.campeche.gob.mx (mail.pgj.campeche.gob.mx [172.24.1.108])
        by mail.pgj.campeche.gob.mx (Postfix) with ESMTP id 189371BC84F6;
        Mon, 27 Jun 2022 23:17:42 -0500 (CDT)
Date:   Mon, 27 Jun 2022 23:17:42 -0500 (CDT)
From:   =?utf-8?B?0YHQuNGB0YLQtdC80L3QuNC5INCw0LTQvNGW0L3RltGB0YLRgNCw0YLQvtGA?= 
        <vfgcontrolinterno@pgj.campeche.gob.mx>
Reply-To: sistemassadmins@mail2engineer.com
Message-ID: <1201364956.1855.1656389862040.JavaMail.zimbra@pgj.campeche.gob.mx>
Subject: 
MIME-Version: 1.0
Content-Type: text/plain; charset=utf-8
X-Originating-IP: [172.24.1.254]
X-Mailer: Zimbra 8.8.15_GA_4304 (zclient/8.8.15_GA_4304)
Thread-Index: o2S6B4k11JaD4thaPAJPAuE9cywKoQ==
Thread-Topic: 
Content-Transfer-Encoding: 8BIT
X-Spam-Status: Yes, score=7.0 required=5.0 tests=BAYES_40,
        FREEMAIL_FORGED_REPLYTO,KHOP_HELO_FCRDNS,MISSING_HEADERS,
        RCVD_IN_MSPIKE_H2,RCVD_IN_VALIDITY_RPBL,RDNS_DYNAMIC,
        REPLYTO_WITHOUT_TO_CC,SPF_HELO_NONE,SPF_NONE,T_SCC_BODY_TEXT_LINE,
