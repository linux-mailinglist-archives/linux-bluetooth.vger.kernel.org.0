Return-Path: <linux-bluetooth+bounces-1034-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-bluetooth@lfdr.de
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 0D0A782A20B
	for <lists+linux-bluetooth@lfdr.de>; Wed, 10 Jan 2024 21:19:05 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id E79201C22BD3
	for <lists+linux-bluetooth@lfdr.de>; Wed, 10 Jan 2024 20:19:03 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 85E554EB50;
	Wed, 10 Jan 2024 20:18:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="SUKiaNE+"
X-Original-To: linux-bluetooth@vger.kernel.org
Received: from mail-lj1-f181.google.com (mail-lj1-f181.google.com [209.85.208.181])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 9571E4E1DE
	for <linux-bluetooth@vger.kernel.org>; Wed, 10 Jan 2024 20:18:25 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-lj1-f181.google.com with SMTP id 38308e7fff4ca-2cd7e348311so11267791fa.2
        for <linux-bluetooth@vger.kernel.org>; Wed, 10 Jan 2024 12:18:25 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1704917903; x=1705522703; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=/DKVxV3/bK/8OA9xLPd6nq9DmwyPUxUtumoHvdeQfp8=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1704917903; x=1705522703;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=/DKVxV3/bK/8OA9xLPd6nq9DmwyPUxUtumoHvdeQfp8=;
        b=
X-Gm-Message-State: AOJu0YzJwWuY6WmNg23vl5YSAX/xb0pz/J4IEmM5YYCVBnb0mTgVOeSZ
	iHnsLKxWsqBTVGYVrExDziT+VwybWMF1W4A8zeg=
X-Google-Smtp-Source: AGHT+IHihIajbIX62iyk/9QgP+OYguKd39wptxq84qKA0qV6qHHN1Dqbx1/vtcEiUqRlGHv2AmjoKJWybJ/rD9ofuwQ=
X-Received: by 2002:a2e:7d15:0:b0:2cc:1d8b:5466 with SMTP id
 y21-20020a2e7d15000000b002cc1d8b5466mr63363ljc.10.1704917902443; Wed, 10 Jan
 2024 12:18:22 -0800 (PST)
Precedence: bulk
...
MIME-Version: 1.0
References: <20240110161100.106191-1-silviu.barbulescu@nxp.com> <20240110161100.106191-3-silviu.barbulescu@nxp.com>
In-Reply-To: <20240110161100.106191-3-silviu.barbulescu@nxp.com>
From: Luiz Augusto von Dentz <luiz.dentz@gmail.com>
Date: Wed, 10 Jan 2024 15:18:08 -0500
Message-ID: <CABBYNZLB6_yO6u_DcZ+=nH8dHw5Dp6LT032zfwNTM523kB58ag@mail.gmail.com>
Subject: Re: [PATCH v4 2/3] bap.c: Add support for multiple BISes
...
On Wed, Jan 10, 2024 at 11:11=E2=80=AFAM Silviu Florian Barbulescu
...
Please split these changes into shared/bap and bap plugin changes,
even the bap.c looks a little too big imo with almost 1K lines
changed.

> diff --git a/profiles/audio/bap.c b/profiles/audio/bap.c
> index b88876485..1fb8a8681 100644
...
hmm, why you need to include lc3.h? Codec specific are normally not
really part of BAP directly.
...
a)
> @@ -258,10 +322,20 @@ static gboolean get_device(const GDBusPropertyTable=
 *property,
...
>
> @@ -370,6 +444,26 @@ static const GDBusPropertyTable ep_properties[] =3D =
{
>         { }
>  };
>
...
> @@ -384,101 +478,323 @@ static int parse_array(DBusMessageIter *iter, str=
uct iovec *iov)
>         return 0;
>  }
>
...
> +       struct update_base_data *update_data =3D user_data;
> +
> +       if (setup->stream =3D=3D update_data->stream)
...
> +
> +       base_iov =3D bt_bap_update_base(setup->stream);
> +
> +       update_data.base =3D base_iov;
> +
> +       /* Update the endpoints BASE iovec */
> +       update_endpoint_base(setup, base_iov);
> +
> +       for (entry =3D queue_get_entries(
> +                               bt_bap_stream_get_link_bcast(setup->strea=
m));
> +                               entry; entry =3D entry->next) {
> +               update_data.stream =3D entry->data;
> +
...
> +       struct bt_bap_qos *qos =3D bt_bap_stream_get_qos(stream);
> +
...
> @@ -561,6 +877,16 @@ static int parse_bcast_qos(const char *key, int var,=
...
These can probably be submitted separately.

>         } else if (!strcasecmp(key, "Options")) {
>                 if (var !=3D DBUS_TYPE_BYTE)
>                         return -EINVAL;
> @@ -596,6 +922,11 @@ static int parse_bcast_qos(const char *key, int var,=
 DBusMessageIter *iter,
>                         return -EINVAL;
>
...
>                 struct iovec iov;
>
> @@ -604,8 +935,8 @@ static int parse_bcast_qos(const char *key, int var, =
DBusMessageIter *iter,
>
...
Not sure why you are reverting to be a copy in place rather than a
pointer reference? Afaik this code above is not safe since it is not
really checking the size of iov.iov_len.

>         } else {
>                 int err;
>
> @@ -618,14 +949,15 @@ static int parse_bcast_qos(const char *key, int var=
, DBusMessageIter *iter,
>  }
>
...
> @@ -657,8 +989,9 @@ static int parse_qos(DBusMessageIter *iter, struct bt=
_bap_qos *qos,
>  }
>
...
>         const char *key;
>         struct iovec iov;
> @@ -699,24 +1032,13 @@ static int parse_configuration(DBusMessageIter *pr=
...
When I said reuse the concept of links I really meant bt_bap_stream
shall be able to link broadcast streams, not have bap_setup start
doing link tracking by itself since with that we won't be able to
validate via test-bap.c.
...
a)
>  {
> @@ -882,13 +1264,46 @@ static DBusMessage *set_configuration(DBusConnecti=
...
;
>
> @@ -900,12 +1315,12 @@ static DBusMessage *set_configuration(DBusConnecti=
on *conn, DBusMessage *msg,
>                 return btd_error_invalid_args(msg);
>         }
>
...
> @@ -914,8 +1329,14 @@ static DBusMessage *set_configuration(DBusConnectio=
...
>         }
> @@ -944,30 +1365,21 @@ static void update_bcast_qos(struct bt_iso_qos *qo=
s,
...
>         if (err) {
>                 error("%s", err->message);
> @@ -976,25 +1388,15 @@ static void iso_bcast_confirm_cb(GIOChannel *io, G=
...
>         bt_bap_stream_set_user_data(setup->stream, ep->path);
>
> @@ -1006,25 +1408,39 @@ static void iso_bcast_confirm_cb(GIOChannel *io, =
...
> @@ -1081,6 +1497,7 @@ static struct bap_ep *ep_register_bcast(struct bap_=
data *data,
>         int i, err =3D 0;
>         const char *suffix;
...
> @@ -1109,11 +1526,15 @@ static struct bap_ep *ep_register_bcast(struct ba=
p_data *data,
>         case BT_BAP_BCAST_SOURCE:
...
>
>         if (err < 0) {
> @@ -1125,7 +1546,7 @@ static struct bap_ep *ep_register_bcast(struct bap_=
data *data,
>
...
>                 ep_free(ep);
> @@ -1646,9 +2067,12 @@ static gboolean setup_io_disconnected(GIOChannel *=
...
>         return FALSE;
>  }
> @@ -1741,7 +2165,7 @@ static void setup_connect_io(struct bap_data *data,=
 struct bap_setup *setup,
...
> @@ -1778,7 +2202,7 @@ static void setup_connect_io_broadcast(struct bap_d=
ata *data,
...
>
>         if (!io) {
> @@ -1832,41 +2256,28 @@ static void setup_listen_io_broadcast(struct bap_=
data *data,
>                                         struct bt_bap_stream *stream,
>                                         struct bt_iso_qos *qos)
>  {
...
>                                         struct bap_setup *setup,
> @@ -1902,32 +2313,37 @@ static void setup_create_bcast_io(struct bap_data=
 *data,
...
> +                                       BT_BAP_BCAST_SOURCE)
> +               qos =3D bt_bap_stream_get_combined_qos(setup->stream);
> +       else
> +               qos =3D &setup->qos;
> +
...
>  }
> @@ -1953,6 +2369,31 @@ static void setup_create_io(struct bap_data *data,=
 struct bap_setup *setup,
>                 break;
>         }
>  }
...
> +               if (bt_bap_stream_get_state(linked_stream) !=3D
> +                                                       test_state)
> +                       return false;
> +       }
> +
...
> @@ -1983,17 +2424,29 @@ static void bap_state(struct bt_bap_stream *strea=
m, uint8_t old_state,
>                 break;
...
>                                                                 &setup->q=
os,
> @@ -2311,6 +2764,12 @@ static int bap_bcast_probe(struct btd_service *ser=
vice)
...
>
> @@ -2349,7 +2808,24 @@ static int bap_bcast_probe(struct btd_service *ser=
vice)
>
...
Please submit a separarate patch with these changes.
...
This is probably wrong, we shouldn't have any Device path that
actually points to a remote endpoint path, it is really meant only for
object implements org.bluez.Device1.
...
Please no, lets to reverts these changes back to storing data on a
bytearray since we cannot use that with the util_iov helpers, if you
have a problem with that please send a separate patch to address it.
...
We probably need to separate the bap_state_changed into
bap_ucast_state_changed and bap_bcast_state_changed to stop having to
check the stream type everywhere.
...
Not sure why you need to include lc3.h?
...
The qos shall always reflect the ISO qos so not sure why you need this fiel=
d?
...
Please prefix these with bt_bap.
...
> @@ -331,6 +360,457 @@ bool bt_bap_pac_unregister(struct bt_bap *bap, unsi=
gned int id)
>         return true;
>  }
>
...
Do you really need to forward declara everything?
...
> +       struct stream_base_data *sbd =3D get_stream_base_info(stream);
> +
...
> @@ -826,6 +1306,7 @@ static struct bt_bap_stream *bap_stream_new(struct b=
t_bap *bap,
>         stream->rpac =3D rpac;
>         stream->cc =3D util_iov_dup(data, 1);
>         stream->client =3D client;
> +       stream->link_bcast_streams =3D queue_new();
>
>         queue_push_tail(bap->streams, stream);
>
> @@ -1010,6 +1491,14 @@ static void stream_io_unref(struct bt_bap_stream_i=
o *io)
>         stream_io_free(io);
>  }
>
...
>
> +       queue_foreach(stream->link_bcast_streams, bap_stream_unlink, stre=
am);
...
> @@ -1343,6 +1835,12 @@ static void stream_set_state_broadcast(struct bt_b=
ap_stream *stream,
>
>         bt_bap_ref(bap);
>
...
> @@ -2377,21 +2875,6 @@ static struct bt_bap_pac *bap_pac_find(struct bt_b=
...
>                                         void *user_data)
>  {
> @@ -2427,7 +2910,7 @@ static void bap_pac_merge(struct bt_bap_pac *pac, s=
truct iovec *data,
>  {
...
>
> @@ -2436,7 +2919,7 @@ static void bap_pac_merge(struct bt_bap_pac *pac, s=
truct iovec *data,
>
...
>  }
> @@ -2650,6 +3133,8 @@ static void bap_add_broadcast_source(struct bt_bap_=
pac *pac)
...
> @@ -2668,6 +3153,20 @@ static void notify_session_pac_added(void *data, v=
oid *user_data)
...
Im note really sure what is going here, why you need to clone a pac?
And if you really need that it should probably be named
bt_bap_pac_clone to begin with, still it really beats me why we need 2
copies of the same pac? In bcast there are just an abstraction of the
base configuration isn't it? Why we need to clone like this? It would
probably help if you have comments on top of the function.

>  struct bt_bap_pac *bt_bap_add_vendor_pac(struct gatt_db *db,
>                                         const char *name, uint8_t type,
>                                         uint8_t id, uint16_t cid, uint16_=
t vid,
> @@ -2725,7 +3224,7 @@ struct bt_bap_pac *bt_bap_add_pac(struct gatt_db *d=
b, const char *name,
>                                         struct iovec *metadata)
>  {
...
> @@ -2748,13 +3247,24 @@ uint32_t bt_bap_pac_get_locations(struct bt_bap_p=
ac *pac)
>         switch (pac->type) {
>         case BT_BAP_SOURCE:
...
>  {
>         struct bt_pacs *pacs;
> @@ -2837,12 +3347,26 @@ static void notify_session_pac_removed(void *data=
, void *user_data)
...
What now? Why we need to do thist?

>         return true;
>  }
>
> @@ -4489,6 +5013,11 @@ bool bt_bap_pac_bcast_is_local(struct bt_bap *bap,=
...
> @@ -4618,7 +5147,6 @@ unsigned int bt_bap_stream_config(struct bt_bap_str=
eam *stream,
...
This sounds more like a fix, if so please submit it as a separate patch.

>                 }
>                 return 1;
>         }
> @@ -4763,7 +5291,7 @@ struct bt_bap_stream *bt_bap_stream_new(struct bt_b=
ap *bap,
>                         return NULL;
>
...
>                         return NULL;
> @@ -4780,7 +5308,15 @@ struct bt_bap_stream *bt_bap_stream_new(struct bt_=
bap *bap,
>         if (!ep) {
...
>                         return NULL;
>                 }
> @@ -4943,11 +5479,10 @@ unsigned int bt_bap_stream_enable(struct bt_bap_s=
tream *stream,
...
Coding style fixes? Please send these as a separate patch.

>                 return 1;
>         }
>
> @@ -5094,13 +5629,21 @@ unsigned int bt_bap_stream_metadata(struct bt_bap=
_stream *stream,
>         if (!stream)
>                 return 0;
>
...
Ok, I might be adding stream->ops after this, it is not very eficient
to have every procedure to end up with a switch
(bt_bap_stream_get_type(stream)) to determine what to do.
...
> @@ -5191,6 +5734,26 @@ struct iovec *bt_bap_stream_get_config(struct bt_b=
ap_stream *stream)
>         return stream->cc;
>  }
>
...
> +}
> +
> +struct bt_bap_qos *bt_bap_stream_get_combined_qos(struct bt_bap_stream *=
stream)
> +{
> +       if (!stream)
> +               return NULL;
...
>  {
>         if (!stream)
> @@ -5207,6 +5770,14 @@ struct iovec *bt_bap_stream_get_metadata(struct bt=
_bap_stream *stream)
>         return stream->meta;
>  }
>
...
>  {
>         struct bt_bap_stream_io *io;
> @@ -5265,6 +5836,23 @@ static bool match_name(const void *data, const voi=
d *match_data)
...
Id probably suggest adding this as util_iov_merge into shared/util.h
if we really need it.

>  int bt_bap_stream_cancel(struct bt_bap_stream *stream, unsigned int id)
>  {
>         struct bt_bap_req *req;
> @@ -5301,9 +5889,9 @@ int bt_bap_stream_io_link(struct bt_bap_stream *str=
eam,
>                 return -EALREADY;
>
...
Why? It doesn't really seems properly formatted according to our
codying style either.

>
>         stream->link =3D link;
> @@ -5328,6 +5916,14 @@ struct bt_bap_stream *bt_bap_stream_io_get_link(st=
...
>  {
>         struct bt_bap_stream *stream =3D data;
> @@ -5484,11 +6080,301 @@ bool bt_bap_new_bcast_source(struct bt_bap *bap,=
 const char *name)
>         return true;
>  }
>
...
Not really following what you are doing above, can you just use
util_ltv_foreach to parse the entries?
...
I suspend we can greatly reduce the completexity of these looks with
use of util_ltv_foreach, it is actually not the first time we
introduce code to parse the base since we do have something similar in
monitor/packet.c:print_base_annoucement, that looks a lot more
readable than this.
...
> @@ -292,8 +319,13 @@ unsigned int bt_bap_stream_release(struct bt_bap_str=
eam *stream,
...
ata);
> @@ -315,9 +347,9 @@ bool bt_bap_stream_io_is_connecting(struct bt_bap_str=
eam *stream, int *fd);
>
