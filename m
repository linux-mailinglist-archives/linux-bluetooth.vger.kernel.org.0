...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 711B842739F
	for <lists+linux-bluetooth@lfdr.de>; Sat,  9 Oct 2021 00:21:36 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243673AbhJHWXW (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Fri, 8 Oct 2021 18:23:22 -0400
Received: from mailgw01.mediatek.com ([216.200.240.184]:7947 "EHLO
        mailgw01.mediatek.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S243683AbhJHWXS (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Fri, 8 Oct 2021 18:23:18 -0400
X-UUID: 111a87eecd30421ea136c11f632b4ed2-20211008
X-UUID: 111a87eecd30421ea136c11f632b4ed2-20211008
Received: from mtkcas66.mediatek.inc [(172.29.193.44)] by mailgw01.mediatek.com
        (envelope-from <sean.wang@mediatek.com>)
        (musrelay.mediatek.com ESMTP with TLSv1.2 ECDHE-RSA-AES256-SHA384 256/256)
        with ESMTP id 1682626370; Fri, 08 Oct 2021 15:20:06 -0700
Received: from mtkcas10.mediatek.inc (172.21.101.39) by
 MTKMBS62N1.mediatek.inc (172.29.193.41) with Microsoft SMTP Server (TLS) id
 15.0.1497.2; Fri, 8 Oct 2021 15:10:26 -0700
Received: from mtkswgap22.mediatek.inc (172.21.77.33) by mtkcas10.mediatek.inc
 (172.21.101.73) with Microsoft SMTP Server id 15.0.1497.2 via Frontend
 Transport; Sat, 9 Oct 2021 06:10:26 +0800
...
Subject: [PATCH v1 01/10] Bluetooth: mediatek: add BT_MTK module
Date:   Sat, 9 Oct 2021 06:10:08 +0800
Message-ID: <91f9748fcd3edd304f12c0e4645c4000c8cc523c.1633728573.git.objelf@gmail.com>
...
---
 ...
 5 files changed, 397 insertions(+), 325 deletions(-)
...
index 000000000000..7ab6cffe5bc1
--- /dev/null
...
index 75c83768c257..3414d971e4a8 100644
...
-}
 ...
 {
@@ -2497,209 +2382,6 @@ static int btusb_mtk_hci_wmt_sync(struct hci_dev *hdev,
 	return err;
 }
...
-
 ...
 {
 	struct btmtk_hci_wmt_params wmt_params;
@@ -2857,7 +2539,8 @@ static int btusb_mtk_setup(struct hci_dev *hdev)
...
@@ -2903,7 +2586,8 @@ static int btusb_mtk_setup(struct hci_dev *hdev)
 	}
...
@@ -3064,9 +2748,6 @@ static int btusb_recv_acl_mtk(struct hci_dev *hdev, struct sk_buff *skb)
...
@@ -3868,7 +3549,7 @@ static int btusb_probe(struct usb_interface *intf,
