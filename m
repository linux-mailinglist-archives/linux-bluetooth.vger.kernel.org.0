Return-Path: <linux-bluetooth+bounces-2906-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-bluetooth@lfdr.de
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [147.75.48.161])
	by mail.lfdr.de (Postfix) with ESMTPS id BB840890167
	for <lists+linux-bluetooth@lfdr.de>; Thu, 28 Mar 2024 15:13:46 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 07775B2419F
	for <lists+linux-bluetooth@lfdr.de>; Thu, 28 Mar 2024 14:13:44 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0FEB27F487;
	Thu, 28 Mar 2024 14:13:37 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="VDMKRFEF"
X-Original-To: linux-bluetooth@vger.kernel.org
Received: from mail-lj1-f172.google.com (mail-lj1-f172.google.com [209.85.208.172])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 3789F14294
	for <linux-bluetooth@vger.kernel.org>; Thu, 28 Mar 2024 14:13:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.208.172
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1711635216; cv=none; b=Ap4viMGo5XMjZuUXl5EZaYRMYG5yQABGImEl7IXtJX0RNUw1fc7GL6KOSHi6ob+BivJJnIEURkLBczjfK8n0L0CEBfVtOvcmGGqjKq9EdoyVxDhtKVa+80w+920La+Bu+IO9xFHfmSpHQaSfKZ0Hf8GGrgwLHKUYCImpW3VcY6A=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1711635216; c=relaxed/simple;
	bh=0Ua3hXRIo5xMv2PO6UCGftxd4dQtRqeUMUa+6nVNVCA=;
	h=MIME-Version:References:In-Reply-To:From:Date:Message-ID:Subject:
	 To:Cc:Content-Type; b=GG35gSgbHOXv9+058R0BYRPBkib4jwiQrFt0H15L7c9tq7Qiotwmlr72w/vMoXrVHwMMzl0yZSvjj2wz1P/3yN8uKdSQeDvtSo0oh55ban6IebQPwsxHf5a3+7ouHgmKtqEtETGA2Dubt2verMNlNp2ziZ1ftgd66YdN/wimp4I=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=VDMKRFEF; arc=none smtp.client-ip=209.85.208.172
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-lj1-f172.google.com with SMTP id 38308e7fff4ca-2d6fd3cfaceso13106161fa.3
        for <linux-bluetooth@vger.kernel.org>; Thu, 28 Mar 2024 07:13:31 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1711635210; x=1712240010; darn=vger.kernel.org;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:from:to:cc:subject:date
         :message-id:reply-to;
        bh=HuliX3SKyTJ2Qno8WdyiLHEwXfSdmeU10p6DQBxDDjA=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1711635210; x=1712240010;
        h=content-transfer-encoding:cc:to:subject:message-id:date:from
         :in-reply-to:references:mime-version:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=HuliX3SKyTJ2Qno8WdyiLHEwXfSdmeU10p6DQBxDDjA=;
        b=
X-Gm-Message-State: AOJu0YwezUNGrRhwBgZCMgdnGBGnfDAXWOeIVHhsVUpgzyRT1Afd1hAp
	oZoDncDrlKodi7/GRT5IGy19ZwESEQ/drwywpZj7Yp9Yj4+d8OPpkrqmS2xAuoxtM/9xkZjeVyX
	JSV1gQd8fNucJI9p5fOdJYDJdng0=
X-Google-Smtp-Source: AGHT+IHNAfYNrlH66O7HEFvIfVvvWjsie+RcEfuC264fTtptkM06gUfta5njAPjqK3lJdzsc7xP9OKKvg0WNh1MypTE=
X-Received: by 2002:a2e:9895:0:b0:2d4:6973:a335 with SMTP id
 b21-20020a2e9895000000b002d46973a335mr2918019ljj.29.1711635209673; Thu, 28
 Mar 2024 07:13:29 -0700 (PDT)
Precedence: bulk
...
Date: Thu, 28 Mar 2024 10:13:17 -0400
Message-ID: <CABBYNZJ_fGPmTe1USpHUWYQyDvcsPc2UHv9j6dPnLm-jt2XxdQ@mail.gmail.com>
...
On Thu, Mar 28, 2024 at 10:09=E2=80=AFAM Luiz Augusto von Dentz
<luiz.dentz@gmail.com> wrote:
>
> Hi Kiran,
>
> On Thu, Mar 28, 2024 at 7:05=E2=80=AFAM Kiran K <kiran.k@intel.com> wrote=
:
> >
...
> > +         This driver is required if you want to use Intel Bluetooth de=
vice
> > +         with PCIe interface.
> > +
> > +         Say Y here to compiler support for Intel Bluetooth PCIe devic=
e into
...
> > +
> > +/* Intel PCIe uses 4 bytes of HCI type instead of 1 byte BT SIG HCI ty=
pe */
...
> > +static inline void btintel_pcie_hci_dump(const char *p, const void *b,=
 int s)
> > +{
...
> > +               i +=3D snprintf(str + i, sizeof(str) - i, "%02x ", ptr[=
c]);
...
> > +       BT_DBG("[TXQ] tfd_index:%u num_txq:%u cmpl_cnt:%u immediate_cmp=
l:0x%x",
...
> > +
> > +static int btintel_pcie_poll_bit(struct btintel_pcie_data *data, u32 o=
ffset,
...
> > +}
> > +
> > +static struct btintel_pcie_data *btintel_pcie_get_data(struct msix_ent=
ry *entry)
> > +{
> > +       u8 queue =3D entry->entry;
> > +       struct msix_entry *entries =3D entry - queue;
> > +
> > +       return container_of(entries, struct btintel_pcie_data, msix_ent=
ries[0]);
> > +}
> > +
...
> > +}
> > +
> > +/* Update the FRBD(free buffer descriptor) with the @frbd_index and th=
e
...
> > +
> > +       /* Read the frbd index from the TR_HIA(Head Index Array) for RX=
Q */
> > +       frbd_index =3D data->ia.tr_hia[RXQ_NUM];
> > +       BT_DBG("[RXQ] current frbd_index: %u", frbd_index);
> > +
> > +       /* Make sure the index value is within the range. It shouldn't =
be
...
> > +       }
> > +
> > +       /* Prepare for RX submit. It updates the FRBD with the address =
of DMA
> > +        * buffer
> > +        */
...
> > +       btintel_pcie_wr_reg32(data, CSR_FUNC_CTRL_REG, CSR_FUNC_CTRL_SW=
_RESET);
> > +}
> > +
> > +/* This function enables BT function by setting CSR_FUNC_CTRL_MAC_INIT=
 bit in
> > + * CSR_FUNC_CTRL_REG register and wait for MSI-X with MSIX_HW_INT_CAUS=
ES_GP0.
...
> > +                             data->ci_p_addr >> 32);
> > +
> > +       /* Reset the cached value of boot stage. it is updated by the m=
six
...
>
> It is useless to printing this sort of information, let alone using BT_IN=
FO...
>
...
> Ditto.
>
> > +       /* wait for interrupt from the device after booting up to prima=
ry
> > +        * bootloader.
> > +        */
...
> > + * CSR_MSIX_HW_INT_CAUSES) which is sent for boot stage and image resp=
onse.
> > + */
> > +static void btintel_pcie_msix_gp0_handler(struct btintel_pcie_data *da=
ta)
> > +{
> > +       u32 reg;
> > +
> > +       /* This interrupt is for three different causes and it is not e=
asy to
> > +        * know what causes the interrupt. So, it compares each registe=
r value
...
> > +}
> > +
> > +/* This function handles the MSX-X interrupt for rx queue 0 which is f=
or TX
> > + */
...
> > +
> > +               /* Make sure the completed TFD index is within the rang=
e */
> > +               if (urbd0->tfd_index > txq->count) {
> > +                       BT_ERR("[TXQ] out of range: (0x%x)", urbd0->tfd=
_index);
> > +                       return;
> > +               }
> > +
...
> > +
> > +               if (skb->len > HCI_EVENT_HDR_SIZE && hdr->evt =3D=3D 0x=
ff &&
> > +                   hdr->plen > 0) {
> > +                       const void *ptr =3D skb->data + HCI_EVENT_HDR_S=
IZE + 1;
> > +                       unsigned int len =3D skb->len - HCI_EVENT_HDR_S=
IZE - 1;
> > +
> > +                       switch (skb->data[2]) {
> > +                       case 0x02:
> > +                               /* When switching to the operational fi=
rmware
> > +                                * the device sends a vendor specific e=
vent
...
> > +                               break;
> > +                       case 0x06:
> > +                               /* When the firmware loading completes =
the
> > +                                * device sends out a vendor specific e=
vent
> > +                                * indicating the result of the firmwar=
e
> > +                                * loading.
> > +                                */
> > +                               btintel_secure_send_result(hdev, ptr, l=
en);
> > +                               break;
> > +                       }
> > +               }
...
> > +
> > +       /* The first 4 bytes indicates the Intel PCIe specific packet t=
ype.
...
> > +               memcpy(skb_put(skb, HCI_ACL_HDR_SIZE), buf, HCI_ACL_HDR=
_SIZE);
...
> > +               memcpy(skb_put(skb, HCI_SCO_HDR_SIZE), buf, HCI_SCO_HDR=
_SIZE);
...
> > +                                       struct btintel_pcie_data, rx_wo=
rk);
> > +       struct sk_buff *skb;
> > +       int err;
> > +
...
> > +               err =3D btintel_pcie_hci_recv_frame(data, skb->data, sk=
b->len);
>
...
Missed this one, it appears we are leaking the skb if err =3D 0.
...
> > + */
> > +static int btintel_pcie_submit_rx_work(struct btintel_pcie_data *data,=
 u8 status,
> > +                                      void *buf)
> > +{
> > +       int ret, len;
...
> > +
> > +       /* Create the sk_buf with packet in the buf and save it to sk_b=
uf queue
> > +        */
...
> > +}
> > +
> > +/* This function handles the MSI-X interrupt for rx queue 1 which is f=
or RX
> > + */
...
> > +       rxq =3D &data->rxq;
> > +
> > +       /* The firmware sends multiple CD in a single MSIX and it needs=
 to
...
> > +               if (!buf) {
> > +                       BT_ERR("[RXQ] failed to get the DMA buffer for =
%d",
> > +                              urbd1->frbd_tag);
> > +                       return;
> > +               }
...
;
> > +
> > +       /* Clear causes registers to avoid being handling the same caus=
e */
...
> > +        * a nested interrupt. This is done by writing 1 to the corresp=
onding
> > +        * bit in the mask register. After handling the interrupt, it s=
hould be
> > +        * re-enabled by clearing this bit. This register is defined as
> > +        * write 1 clear (W1C) register, meaning that it's being clear
> > +        * by writing 1 to the bit.
> > +        */
> > +       btintel_pcie_wr_reg32(data, CSR_MSIX_AUTOMASK_ST, BIT(entry->en=
try));
> > +
> > +       return IRQ_HANDLED;
> > +}
> > +
> > +/* This function requests the irq for msix and registers the handlers =
per irq.
...
> > +       }
> > +
> > +       num_irqs =3D pci_enable_msix_range(data->pdev, data->msix_entri=
es,
> > +                                        MSIX_VEC_MIN,
> > +                                        MSIX_VEC_MAX);
> > +       if (num_irqs < 0) {
...
> > +                                               btintel_pcie_irq_msix_h=
andler,
> > +                                               IRQF_SHARED,
> > +                                               KBUILD_MODNAME,
> > +                                               msix_entry);
> > +               if (err) {
> > +                       BT_ERR("Failed to allocate irq handler (%d)", e=
rr);
> > +                       return err;
> > +               }
> > +       }
...
> > + *
> > + * After resetting BT function via PCIE FLR or FUNC_CTRL reset, the dr=
iver
> > + * need to call this function again to configure it again since the ma=
sks
...
> > +                                    CSR_MSIX_IVAR(causes_list[i].cause=
_num),
> > +                                    val);
...
> > +       data->fh_init_mask =3D ~btintel_pcie_rd_reg32(data, CSR_MSIX_FH=
_INT_MASK);
> > +       data->hw_init_mask =3D ~btintel_pcie_rd_reg32(data, CSR_MSIX_HW=
_INT_MASK);
...
> > +               err =3D dma_set_mask_and_coherent(&pdev->dev, DMA_BIT_M=
ASK(32));
> > +               /* Both attempt failed */
> > +               if (err) {
...
> > +       txq->bufs =3D kmalloc_array(txq->count, sizeof(*buf), GFP_KERNE=
L);
> > +       if (!txq->bufs) {
> > +               err =3D -ENOMEM;
> > +               goto exit_error;
> > +       }
> > +
> > +       /* Allocate full chunk of data buffer for DMA first and do inde=
xing and
...
> > +
> > +       /* Allocate the same number of buffers as the descriptor */
> > +       rxq->bufs =3D kmalloc_array(rxq->count, sizeof(*buf), GFP_KERNE=
L);
> > +       if (!rxq->bufs) {
> > +               err =3D -ENOMEM;
> > +               goto exit_error;
...
> > +
> > +       dma_pool_free(data->dma_pool, data->dma_v_addr, data->dma_p_add=
r);
...
> > +       void *v_addr;
> > +
> > +       /* Allocate the chunk of DMA memory for descriptors, index arra=
y, and
> > +        * context information, instead of allocating individually.
> > +        * The DMA memory for data buffer is allocated while setting up=
 the
> > +        * each queue.
> > +        *
...
> > +        *  + size of index * Number of queues(2) * type of index array=
(4)
> > +        *  + size of context information
> > +        */
> > +       total =3D (sizeof(struct tfd) + sizeof(struct urbd0) + sizeof(s=
truct frbd)
> > +               + sizeof(struct urbd1)) * DESCS_COUNT;
> > +
> > +       /* Add the sum of size of index array and size of ci struct */
> > +       total +=3D (sizeof(u16) * NUM_QUEUES * 4) + sizeof(struct ctx_i=
nfo);
> > +
> > +       /* Allocate DMA Pool */
> > +       data->dma_pool =3D dma_pool_create(KBUILD_MODNAME, &data->pdev-=
>dev,
...
> > +       }
> > +
> > +       v_addr =3D dma_pool_zalloc(data->dma_pool, GFP_KERNEL | __GFP_N=
OWARN,
> > +                                &p_addr);
> > +       if (!v_addr) {
...
> > +
> > +       BT_DBG("dma pool: p_addr=3D0x%llx v_addr=3D0x%p", p_addr, v_add=
r);
> > +
...
> > +
> > +       data->workqueue =3D alloc_ordered_workqueue(KBUILD_MODNAME, WQ_=
HIGHPRI);
> > +       if (!data->workqueue) {
...
> > +        * enabling pice device, setting master, reading BAR[0], config=
uring
...
> > +MODULE_DESCRIPTION("Intel Bluetooth PCIe transport driver ver " VERSIO=
N);
...
> > +}
> > +
> > +static inline void btintel_pcie_wr_reg32(struct btintel_pcie_data *dat=
a,
> > +                                        u32 offset, u32 val)
> > +{
...
> > +}
> > +
> > +static inline void btintel_pcie_set_reg_bits(struct btintel_pcie_data =
*data,
> > +                                            u32 offset, u32 bits)
> > +{
> > +       u32 r;
...
> > +}
> > +
> > +static inline void btintel_pcie_clr_reg_bits(struct btintel_pcie_data =
*data,
> > +                                            u32 offset, u32 bits)
> > +{
> > +       u32 r;
