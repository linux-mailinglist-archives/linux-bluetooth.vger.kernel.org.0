Return-Path: <linux-bluetooth+bounces-1795-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-bluetooth@lfdr.de
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id D4028851E4C
	for <lists+linux-bluetooth@lfdr.de>; Mon, 12 Feb 2024 21:03:22 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 1AFC4B22097
	for <lists+linux-bluetooth@lfdr.de>; Mon, 12 Feb 2024 20:03:20 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 9D1724BA9A;
	Mon, 12 Feb 2024 20:02:41 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b="B9JehHme"
X-Original-To: linux-bluetooth@vger.kernel.org
Received: from smtp.kernel.org (aws-us-west-2-korg-mail-1.web.codeaurora.org [10.30.226.201])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 82BDE47F64
	for <linux-bluetooth@vger.kernel.org>; Mon, 12 Feb 2024 20:02:40 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=10.30.226.201
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707768160; cv=none; b=Rl2rKYuBvuJly/f6xdO4LvqYkljhQoBt3ik9FOY4INP7YtEg4ZPDkgDhH+SSysvjQCMQb6O9M4jx+rqJ+iL+4Eh5qB4hDzH9JDOMJlxfNd6WiP7bBA5FMNfKYafq2yNC8wg0ffsa0NmoeLXP0BkoFMtL+N+10Hi8iDgSWT3DlF8=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707768160; c=relaxed/simple;
	bh=iP8MRNwAv5TnlQX539b+3OyPDt5YaK44sFmfygYqvi8=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=Kg1xHgvB214hxuW/8XZC97m1ZSODw5EyY/lLJMK8sRNznjwz2wa+L92SLWEnXyG3o4ff6/3czHl6sTXygqs/7GtbnlOU7QOLmss/OFCr+1RFdAaH4gl2xDm2+Ac5Ydk5fuRIcN/w5S+PPiYIQ8WY66JRklFg33JrHHBfgfs/3FI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dkim=pass (2048-bit key) header.d=kernel.org header.i=@kernel.org header.b=B9JehHme; arc=none smtp.client-ip=10.30.226.201
Received: by smtp.kernel.org (Postfix) with ESMTPS id 201DEC433B2;
	Mon, 12 Feb 2024 20:02:40 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
	s=k20201202; t=1707768160;
	bh=iP8MRNwAv5TnlQX539b+3OyPDt5YaK44sFmfygYqvi8=;
	h=From:Date:Subject:References:In-Reply-To:To:Cc:Reply-To:From;
	b=
Received: from aws-us-west-2-korg-lkml-1.web.codeaurora.org (localhost.localdomain [127.0.0.1])
	by smtp.lore.kernel.org (Postfix) with ESMTP id 0FFEBC4829E;
	Mon, 12 Feb 2024 20:02:40 +0000 (UTC)
From: Emil Velikov via B4 Relay <devnull+emil.l.velikov.gmail.com@kernel.org>
Date: Mon, 12 Feb 2024 20:02:43 +0000
Subject: [PATCH BlueZ v2 07/10] obex: remove phonebook tracker backend
Precedence: bulk
...
Message-Id: <20240212-disto-patches-v2-7-8bab1bd08f4d@gmail.com>
...
X-Mailer: b4 0.12.4
X-Developer-Signature: v=1; a=ed25519-sha256; t=1707768157; l=50891;
 i=emil.l.velikov@gmail.com; s=20230301; h=from:subject:message-id;
 bh=CwywbdVS/jMY/+HJVXb9evcgRdPZmEHnvV6rEJJPjh4=;
 b=+M0gWHB/3pT2Y2QNE/pUtsbx2tPdeqM3l09naJHE/vn5f0dUzpyTfSUAIj7WvECehN7wRowUU
 En5R+GAtPMUDVO+hSspEOk3tWiGswgccgtNDmcpYevgV+lny1zR2ryb
...
index 0e50b1fa4..1d37a1bd4 100644
--- a/Makefile.obexd
+++ b/Makefile.obexd
@@ -48,8 +48,7 @@ obexd_builtin_sources += obexd/plugins/pbap.c \
...
index 5eb7ee0e0..387db8c7d 100644
--- a/configure.ac
+++ b/configure.ac
@@ -443,11 +443,11 @@ AC_ARG_WITH([phonebook], AS_HELP_STRING([--with-phonebook=PLUGIN],
...
+elif (test "${plugin_phonebook}" = "ebook"); then
