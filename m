Return-Path: <linux-bluetooth+bounces-1833-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-bluetooth@lfdr.de
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from sy.mirrors.kernel.org (sy.mirrors.kernel.org [IPv6:2604:1380:40f1:3f00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 4E5A9853603
	for <lists+linux-bluetooth@lfdr.de>; Tue, 13 Feb 2024 17:30:38 +0100 (CET)
Received: from smtp.subspace.kernel.org (wormhole.subspace.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sy.mirrors.kernel.org (Postfix) with ESMTPS id 9D4D4B26AA0
	for <lists+linux-bluetooth@lfdr.de>; Tue, 13 Feb 2024 16:30:35 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id E35E6AD2C;
	Tue, 13 Feb 2024 16:30:22 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="PSpDLeg3"
X-Original-To: linux-bluetooth@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.12])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D3F0EB66F
	for <linux-bluetooth@vger.kernel.org>; Tue, 13 Feb 2024 16:30:19 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.12
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1707841822; cv=none; b=iTOiKgJfVpZjZjDOCUaUYd/v/tZm0hEFcOlOUyK/yc2Jj38AKAT97ouYjmF8dBsZv2hrw6ptngJi4RVF5WJjO7MxDzLCi0XwtS9GpaFdIzsy9NxUlr/viSgO5shntgSO8uljQDd2jVgtadkUecgCqwZim31nWn4aaLyh33t4SjQ=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1707841822; c=relaxed/simple;
	bh=Oty5VmaJaMNH67329QCojrxEywbnUoQWP7ARVWqdvsQ=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=hy4S0VmkYjgYJVkbbVbKCf3EMfsztuRLMsxBXkPP6xYtNwv9afH/v5IbnRtFoYMGq8Oa/bkF/xTIGC4g8vLSOhtl4jjwjbyXe6jAcdqbeX7ZTHQtba1nLr8barf0d+wfcFgLUwpaEdnRnDCMZDVJG786H84YyFs3i3fjaSA9PyQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=PSpDLeg3; arc=none smtp.client-ip=192.198.163.12
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1707841820; x=1739377820;
  h=from:to:cc:subject:date:message-id:in-reply-to:
   references:mime-version:content-transfer-encoding;
  bh=Oty5VmaJaMNH67329QCojrxEywbnUoQWP7ARVWqdvsQ=;
  b=PSpDLeg3Lu4hS2cb2fer/zKLx4d9QbBVOFijf/wo+86d8+Pfb4kW4gMO
   GBXtaEg28Un63eKMvVfZbkgFDED8gHQoHJpee/IfEqe+fC9TTWo5C8NtV
   t/Z1ZGmHIA8HGFbTAhRHUV85jbmsU01QTrQb7dfHj7/SJpDEGkWIKPfS7
   vgonlcAqh8rvBJzqRVdVkmjEwmrJ0SVqA3oFAm0FS2iyUPNDKlT/k/eQU
   OoRc01XK4TtKlD19oUN+7Ufh7Leail70zEOeqhJVoL9ZdUg3va0mDP4c1
   iijc4aAQpu4l2Eq6Wzu0fg3iAO6N3I63mancK4IEVYaqAtcTnQvh0yi7v
   Q==;
X-IronPort-AV: E=McAfee;i="6600,9927,10982"; a="5629513"
X-IronPort-AV: E=Sophos;i="6.06,157,1705392000"; 
   d="scan'208";a="5629513"
Received: from orviesa009.jf.intel.com ([10.64.159.149])
  by fmvoesa106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 13 Feb 2024 08:30:19 -0800
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.06,157,1705392000"; 
   d="scan'208";a="2904805"
Received: from weba0535.iind.intel.com ([10.224.186.30])
  by orviesa009.jf.intel.com with ESMTP; 13 Feb 2024 08:30:18 -0800
From: Ajay KV <ajay.k.v@intel.com>
To: linux-bluetooth@vger.kernel.org
Cc: kiran.k@intel.com,
	Ajay KV <ajay.k.v@intel.com>
Subject: [PATCH v2 3/3] shared/ccp: Add initial code for Call Control Profile for Client Role
Date: Tue, 13 Feb 2024 23:57:03 +0200
Message-Id: <20240213215703.21507-6-ajay.k.v@intel.com>
...
index 000000000000..8e1b0b58f93b
--- /dev/null
+++ b/src/shared/ccp.c
@@ -0,0 +1,1226 @@
...
new file mode 100644
index 000000000000..28b8b034ece3
--- /dev/null
+++ b/src/shared/ccp.h
@@ -0,0 +1,45 @@
+/* SPDX-License-Identifier: LGPL-2.1-or-later */
