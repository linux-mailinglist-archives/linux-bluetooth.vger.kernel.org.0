...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id DC2A33BC63B
	for <lists+linux-bluetooth@lfdr.de>; Tue,  6 Jul 2021 07:55:07 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230048AbhGFF5o (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Tue, 6 Jul 2021 01:57:44 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:56720 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230008AbhGFF5o (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Tue, 6 Jul 2021 01:57:44 -0400
Received: from mail-io1-xd2b.google.com (mail-io1-xd2b.google.com [IPv6:2607:f8b0:4864:20::d2b])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4748EC061574
        for <linux-bluetooth@vger.kernel.org>; Mon,  5 Jul 2021 22:55:06 -0700 (PDT)
Received: by mail-io1-xd2b.google.com with SMTP id a6so23466996ioe.0
        for <linux-bluetooth@vger.kernel.org>; Mon, 05 Jul 2021 22:55:06 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=A5ig+8s3GXXcUQ50jErPUrA/wgu9iN/cPYg3X81pDOs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=A5ig+8s3GXXcUQ50jErPUrA/wgu9iN/cPYg3X81pDOs=;
        b=
X-Gm-Message-State: AOAM5303dyMtdzB4ygS1VaRoxGI1xz1CCNaCskyI/hI3XMmdG3Aj6QC4
        o7F17F/6IwAoBmLBoHAz2fTE44esM3oDercws6Q=
X-Google-Smtp-Source: ABdhPJybWh7sn0KncyIftDbejQxytwv1lKfpjEVUpKZgHdZ2f/A4rsE6RPPZk3/eYSNDbgfKVEwC4SPnMTADKMRtsrQ=
X-Received: by 2002:a02:c851:: with SMTP id r17mr15297817jao.13.1625550905328;
 Mon, 05 Jul 2021 22:55:05 -0700 (PDT)
MIME-Version: 1.0
References: <20210706043205.171122-1-hj.tedd.an@gmail.com> <20210706043205.171122-2-hj.tedd.an@gmail.com>
In-Reply-To: <20210706043205.171122-2-hj.tedd.an@gmail.com>
From:   Sathish Narasimman <nsathish41@gmail.com>
Date:   Tue, 6 Jul 2021 11:24:54 +0530
Message-ID: <CAOVXEJJb_bgrTc4H4=8LxebFRf0Zt__dM2srGecgp_baTvzW2w@mail.gmail.com>
Subject: Re: [RFC BlueZ PATCH v5 2/2] tools/mgmt-tester: Add LL Privacy test cases
...
We can use the below term for the inclusive lanquage as per bluetooth-sig

master -> initiator or central
slave  -> responder or peripheral
blacklist -> reject list
whitelist -> accept list



On Tue, Jul 6, 2021 at 10:03 AM Tedd Ho-Jeong An <hj.tedd.an@gmail.com> wrote:
>
...
> ---
>  emulator/btdev.c    |    2 +-
>  tools/mgmt-tester.c | 1530 +++++++++++++++++++++++++++++++++++--------
>  2 files changed, 1246 insertions(+), 286 deletions(-)
>
> diff --git a/emulator/btdev.c b/emulator/btdev.c
> index 75cca7549..71d55846c 100644
> --- a/emulator/btdev.c
> +++ b/emulator/btdev.c
> @@ -4633,7 +4633,7 @@ static int cmd_remove_adv_set(struct btdev *dev, const void *data,
...
> index d2ded574e..4beb21022 100644
...
I think the name "white_list" is changed to "accept_list".
...
>                                         const void *param, void *user_data)
>  {
> @@ -9320,206 +9403,877 @@ static const struct generic_data set_exp_feat_unknown = {
...
> @@ -9540,6 +10294,28 @@ static bool power_off(uint16_t index)
>         return true;
>  }
>
...
>  {
>         struct test_data *data = tester_get_data();
> @@ -9578,6 +10354,14 @@ static void test_command_generic(const void *test_data)
>                 hciemu_add_master_post_command_hook(data->hciemu,
...
> @@ -10390,13 +11174,6 @@ int main(int argc, char *argv[])
...
> @@ -10796,26 +11573,6 @@ int main(int argc, char *argv[])
...
> @@ -10847,20 +11604,6 @@ int main(int argc, char *argv[])
...
> @@ -11409,6 +12152,45 @@ int main(int argc, char *argv[])
...
>                                         NULL, test_command_generic);
> @@ -11674,6 +12456,184 @@ int main(int argc, char *argv[])
