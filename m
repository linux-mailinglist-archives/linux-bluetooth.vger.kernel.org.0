...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7458B43A856
	for <lists+linux-bluetooth@lfdr.de>; Tue, 26 Oct 2021 01:41:14 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S235511AbhJYXnd (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Mon, 25 Oct 2021 19:43:33 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:53918 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S235411AbhJYXna (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Mon, 25 Oct 2021 19:43:30 -0400
Received: from mail-pl1-x629.google.com (mail-pl1-x629.google.com [IPv6:2607:f8b0:4864:20::629])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 1B4E7C061767
        for <linux-bluetooth@vger.kernel.org>; Mon, 25 Oct 2021 16:41:08 -0700 (PDT)
Received: by mail-pl1-x629.google.com with SMTP id n12so4327079plc.2
        for <linux-bluetooth@vger.kernel.org>; Mon, 25 Oct 2021 16:41:08 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=g8n5GfwWD0oXa6x84XAO2rpLyxf/Nl1TWsu3UYhy61k=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=g8n5GfwWD0oXa6x84XAO2rpLyxf/Nl1TWsu3UYhy61k=;
        b=
X-Gm-Message-State: AOAM532wT7oQKkj4mLLv5K01MZdajkBXfVixlI+4hwLBUty4FG0Y0Zsg
        8Q/lONa5Dzaq+sL/2p1W28WIXkmIyXA=
X-Google-Smtp-Source: ABdhPJwGGo8o7L+q9jM3eUBbe8t+J62Tx3yHdGT04Jsym6Qgd8Yi54Rq+VsTFbKM2uuvrhALd2+ftg==
X-Received: by 2002:a17:902:eac2:b0:140:1d32:ed16 with SMTP id p2-20020a170902eac200b001401d32ed16mr19587376pld.64.1635205266926;
        Mon, 25 Oct 2021 16:41:06 -0700 (PDT)
Received: from lvondent-mobl4.intel.com (c-71-56-157-77.hsd1.or.comcast.net. [71.56.157.77])
        by smtp.gmail.com with ESMTPSA id g7sm16607133pgp.17.2021.10.25.16.41.06
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 25 Oct 2021 16:41:06 -0700 (PDT)
From:   Luiz Augusto von Dentz <luiz.dentz@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [PATCH v5 05/23] Bluetooth: hci_sync: Enable advertising when LL privacy is enabled
Date:   Mon, 25 Oct 2021 16:40:44 -0700
Message-Id: <20211025234102.1140719-6-luiz.dentz@gmail.com>
...
Test Summary
------------
LL Privacy - Add Device 1 (Add to WL)                Passed       0.018 seconds
LL Privacy - Add Device 2 (Add to RL)                Passed       0.020 seconds
LL Privacy - Add Device 3 (Enable RL)                Passed       0.021 seconds
LL Privacy - Add Device 4 (2 Devices to WL)          Passed       0.021 seconds
LL Privacy - Add Device 5 (2 Devices to RL)          Passed       0.021 seconds
LL Privacy - Add Device 6 (RL is full)               Passed       0.022 seconds
LL Privacy - Add Device 7 (WL is full)               Passed       0.023 seconds
LL Privacy - Add Device 8 (Disable Adv)              Passed       0.020 seconds
LL Privacy - Add Device 9 (Multi Adv)                Passed       0.024 seconds
LL Privacy - Add Device 10 (Multi Dev and Multi Adv) Passed       0.025 seconds
LL Privacy - Remove Device 1 (Remove from WL)        Passed       0.022 seconds
LL Privacy - Remove Device 2 (Remove from RL)        Passed       0.023 seconds
LL Privacy - Remove Device 3 (Disable RL)            Passed       0.022 seconds
LL Privacy - Remove Device 4 (Disable Adv)           Passed       0.025 seconds
LL Privacy - Remove Device 5 (Multi Adv)             Passed       0.029 seconds
LL Privacy - Start Discovery 1 (Disable RL)          Passed       0.019 seconds
LL Privacy - Start Discovery 2 (Disable RL)          Passed       0.024 seconds
...
index 15f1546908b4..502478a210e0 100644
...
index 94667efc4395..f39b51300f15 100644
