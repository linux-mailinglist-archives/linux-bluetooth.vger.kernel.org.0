Return-Path: <linux-bluetooth+bounces-18958-lists+linux-bluetooth=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-bluetooth@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id cEAFLRd6jGkcpgAAu9opvQ
	(envelope-from <linux-bluetooth+bounces-18958-lists+linux-bluetooth=lfdr.de@vger.kernel.org>)
	for <lists+linux-bluetooth@lfdr.de>; Wed, 11 Feb 2026 13:46:15 +0100
X-Original-To: lists+linux-bluetooth@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 2A3971247C0
	for <lists+linux-bluetooth@lfdr.de>; Wed, 11 Feb 2026 13:46:15 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 77D3F3006153
	for <lists+linux-bluetooth@lfdr.de>; Wed, 11 Feb 2026 12:46:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 15EFA1D5170;
	Wed, 11 Feb 2026 12:46:12 +0000 (UTC)
X-Original-To: linux-bluetooth@vger.kernel.org
Received: from relay7-d.mail.gandi.net (relay7-d.mail.gandi.net [217.70.183.200])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 16576219E8D
	for <linux-bluetooth@vger.kernel.org>; Wed, 11 Feb 2026 12:46:07 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=217.70.183.200
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1770813971; cv=none; b=RLS/WXfLbftJNg6YHFCsHMqQ+/CDDs7Lt0EC7XKbCoRgPJzYgOgpw128g2wxN4I6+tgmJsHKBupuMdn7kp/Na5MhwSgsqjVGjMDB48+ebDJupOPqhg5OJrcWqKsq9W2R8GE6IUaLxONdnk9+1MjD/KXlXNJdHzah26ufKQlEabk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1770813971; c=relaxed/simple;
	bh=xdNTtUsxB5Fh3Zpy73HezTdAHmU0vn32JHRMdEPJi2Q=;
	h=From:To:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=EdKr5llBAzxysAWzhydabSrqX6PPmcLI6+NnEDjNIKZUyhdCrITQKXnPIW095vdegF5wuTiZTARau/U+HgtawhFH58HxuFCJyBviTeqcMFsnlGOEoq6fdGQVuRXjeMx60yyAZ7v+JBktYSlLWHNYNXZYSnql7dMjtKqsoQGAd+M=
...
Received: by mail.gandi.net (Postfix) with ESMTPSA id B5939441E9
	for <linux-bluetooth@vger.kernel.org>; Wed, 11 Feb 2026 12:45:59 +0000 (UTC)
From: Bastien Nocera <hadess@hadess.net>
To: linux-bluetooth@vger.kernel.org
Subject: [PATCH BlueZ v8 02/15] build: Add meson build system
Date: Wed, 11 Feb 2026 13:41:58 +0100
Message-ID: <20260211124550.3830639-3-hadess@hadess.net>
...
X-GND-State: clean
X-GND-Score: 0
X-GND-Cause: 
 hgvlhdrohhrgh
...
X-Spamd-Result: default: False [0.04 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-18958-lists,linux-bluetooth=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[sto.lore.kernel.org:helo,sto.lore.kernel.org:rdns,meson.build:url,service.in:url,hadess.net:mid,0.0.0.0:email,bluezutils.py:url,agent.py:url,mesonbuild.com:url,rst2man.py:url,dbusdef.py:url]
X-Rspamd-Queue-Id: 2A3971247C0
...
---
 ...
 tools/meson.build            | 319 +++++++++++++++++++++++++++++++++++
 tools/mpris-proxy.service.in |   2 +-
 unit/meson.build             | 125 ++++++++++++++
 24 files changed, 1775 insertions(+), 1 deletion(-)
...
new file mode 100644
index 000000000000..08cd23b332c5
--- /dev/null
...
new file mode 100644
index 000000000000..ca9fbb4e6fdb
--- /dev/null
+++ b/doc/meson.build
@@ -0,0 +1,172 @@
+man_pages = [
...
new file mode 100644
index 000000000000..ac01b7025457
--- /dev/null
+++ b/mesh/meson.build
@@ -0,0 +1,60 @@
...
new file mode 100644
index 000000000000..3473ed64ee90
--- /dev/null
+++ b/meson.build
@@ -0,0 +1,289 @@
...
new file mode 100644
index 000000000000..c0a2d35e3b84
--- /dev/null
+++ b/meson_options.txt
@@ -0,0 +1,52 @@
...
new file mode 100644
index 000000000000..44197f2d3ba2
--- /dev/null
...
new file mode 100644
index 000000000000..9d4c39c78a52
--- /dev/null
...
+endif
+
+if get_option('tmap').enabled()
+  builtin_modules += 'tmap'
+  builtin_sources += files('audio/tmap.c')
+endif
+
+if get_option('gmap').enabled()
+  builtin_modules += 'gmap'
+  builtin_sources += files('audio/gmap.c')
+endif
+
+if get_option('hfp').enabled()
+  builtin_modules += 'hfp'
...
new file mode 100644
index 000000000000..c82085b8a519
--- /dev/null
+++ b/src/meson.build
@@ -0,0 +1,88 @@
+subdir('shared')
...
new file mode 100644
index 000000000000..ae9a65e1b5c6
--- /dev/null
...
new file mode 100644
index 000000000000..6f93cf8a36e0
--- /dev/null
+++ b/test/meson.build
@@ -0,0 +1,37 @@
+test_scripts = [
...
new file mode 100644
index 000000000000..194016a49d2e
--- /dev/null
+++ b/tools/meson.build
@@ -0,0 +1,319 @@
+tools_man_pages = [
...
new file mode 100644
index 000000000000..b53568ccb76d
--- /dev/null
+++ b/unit/meson.build
@@ -0,0 +1,125 @@
+
...
+
+exe = executable('test-profile',
+  sources: [ 'test-profile.c', 'btd.c', '../src/profile.c' ],
+  dependencies: [ dbus_dep, libshared_glib_dep, libbluetooth_internal_dep ]
+)
