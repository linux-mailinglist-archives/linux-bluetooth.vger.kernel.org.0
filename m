...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 9D0F33CF16C
	for <lists+linux-bluetooth@lfdr.de>; Tue, 20 Jul 2021 03:38:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S238669AbhGTA4x (ORCPT <rfc822;lists+linux-bluetooth@lfdr.de>);
        Mon, 19 Jul 2021 20:56:53 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:37932 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S238385AbhGTAz4 (ORCPT
        <rfc822;linux-bluetooth@vger.kernel.org>);
        Mon, 19 Jul 2021 20:55:56 -0400
Received: from mail-pf1-x42d.google.com (mail-pf1-x42d.google.com [IPv6:2607:f8b0:4864:20::42d])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 999F0C061762
        for <linux-bluetooth@vger.kernel.org>; Mon, 19 Jul 2021 18:36:34 -0700 (PDT)
Received: by mail-pf1-x42d.google.com with SMTP id m83so18301913pfd.0
        for <linux-bluetooth@vger.kernel.org>; Mon, 19 Jul 2021 18:36:34 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20161025;
        h=from:to:subject:date:message-id:in-reply-to:references:mime-version
         :content-transfer-encoding;
        bh=0DpyeGcTsN98p46J6kE0jss4ou6vaKBdIXH3pTBilGE=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=0DpyeGcTsN98p46J6kE0jss4ou6vaKBdIXH3pTBilGE=;
        b=
X-Gm-Message-State: AOAM530Llm6clju8GgcYdtACeRBBIYBBaS/sInFx8Nzd2jCFwIPFZvrb
        hSsn0MmVBXdIjtRIcttzGBpj3AfG1vU=
X-Google-Smtp-Source: ABdhPJzg0dQH5mGPQ6Tw4nOoCZFiYBkKCzjMi3KEpH+Xta4nDgkj7wqIk1Kkjeh5IpeJpQmuEJ0h+Q==
X-Received: by 2002:a05:6a00:1786:b029:32c:c315:7348 with SMTP id s6-20020a056a001786b029032cc3157348mr28967644pfg.42.1626744993623;
        Mon, 19 Jul 2021 18:36:33 -0700 (PDT)
Received: from han1-mobl3.hsd1.or.comcast.net ([2601:1c0:6a01:d830::b4ad])
        by smtp.gmail.com with ESMTPSA id u12sm4940087pju.15.2021.07.19.18.36.32
        for <linux-bluetooth@vger.kernel.org>
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 19 Jul 2021 18:36:33 -0700 (PDT)
From:   Tedd Ho-Jeong An <hj.tedd.an@gmail.com>
To:     linux-bluetooth@vger.kernel.org
Subject: [BlueZ PATCH v8 2/2] tools/mgmt-tester: Add LL Privacy test cases
Date:   Mon, 19 Jul 2021 18:36:30 -0700
Message-Id: <20210720013630.478929-2-hj.tedd.an@gmail.com>
...
---
 emulator/btdev.c    |    2 +-
 tools/mgmt-tester.c | 1668 +++++++++++++++++++++++++++++++++++--------
 2 files changed, 1380 insertions(+), 290 deletions(-)

diff --git a/emulator/btdev.c b/emulator/btdev.c
index 5041a68e6..87a0e14a7 100644
--- a/emulator/btdev.c
+++ b/emulator/btdev.c
@@ -4760,7 +4760,7 @@ static int cmd_remove_adv_set(struct btdev *dev, const void *data,
...
index e369d7488..db1f6d96c 100644
...
+	const struct hci_cmd_data *expect_hci_list;
 	...
 	uint8_t pin_len;
 	const void *pin;
@@ -2095,24 +2110,6 @@ static const struct generic_data start_discovery_valid_param_power_off_1 = {
...
@@ -4227,71 +4224,6 @@ static const struct generic_data add_device_success_5 = {
...
-
 static const uint8_t remove_device_nval_1[] = {
 					0x12, 0x34, 0x56, 0x78, 0x9a, 0xbc,
 					0xff,
@@ -4411,36 +4343,6 @@ static const struct generic_data remove_device_success_6 = {
 	.expect_status = MGMT_STATUS_SUCCESS,
 };
...
@@ -7142,6 +7044,54 @@ static void command_hci_callback(uint16_t opcode, const void *param,
...
+
 ...
 {
@@ -8217,6 +8167,189 @@ static const struct generic_data multi_ext_advertising_add_second = {
...
@@ -9131,6 +9264,7 @@ static const struct generic_data start_discovery_le_1m_coded_scan_param = {
...
+
 static void set_phy_callback(uint8_t status, uint16_t length,
 					const void *param, void *user_data)
 {
@@ -9389,137 +9523,854 @@ static const struct generic_data set_exp_feat_unknown = {
...
+					add_device_le_public_param_3,
 	...
 	mgmt_send(data->mgmt, MGMT_OP_SET_POWERED, data->mgmt_index,
@@ -9527,68 +10378,91 @@ static void setup_ll_privacy_device(const void *test_data)
 					setup_powered_callback, NULL, NULL);
 }
...
@@ -9609,6 +10483,28 @@ static bool power_off(uint16_t index)
 	return true;
 }
...
+
 ...
 {
 	struct test_data *data = tester_get_data();
@@ -9647,6 +10543,14 @@ static void test_command_generic(const void *test_data)
 		hciemu_add_master_post_command_hook(data->hciemu,
...
@@ -10459,13 +11363,6 @@ int main(int argc, char *argv[])
...
@@ -10872,26 +11769,6 @@ int main(int argc, char *argv[])
...
@@ -10923,20 +11800,6 @@ int main(int argc, char *argv[])
...
@@ -11485,6 +12348,55 @@ int main(int argc, char *argv[])
...
+					test_command_generic);
 	...
 	test_bredrle50("Get PHY Success", &get_phy_success,
 					NULL, test_command_generic);
@@ -11750,6 +12662,184 @@ int main(int argc, char *argv[])
